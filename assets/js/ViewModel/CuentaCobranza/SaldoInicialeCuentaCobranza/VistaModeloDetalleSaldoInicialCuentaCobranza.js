VistaModeloDetalleSaldoInicialCuentaCobranza = function (data, parent) {
  var self = this;
  ...
  self.InputCodigoMercaderia = ko.computed( function() {
    return self.IdDetalleSaldoInicialCuentaCobranza ? "#input_CodigoMercaderia_" + self.IdDetalleSaldoInicialCuentaCobranza() : "";
  },this);

  self.InputProducto = ko.computed( function() {
    return self.IdDetalleSaldoInicialCuentaCobranza ? "#input_NombreProducto_" + self.IdDetalleSaldoInicialCuentaCobranza() : "";
  },this);

  self.InputCantidad = ko.computed( function() {
    return self.IdDetalleSaldoInicialCuentaCobranza ? "#input_Cantidad_" + self.IdDetalleSaldoInicialCuentaCobranza() : "";
  },this);

  self.InputPrecioUnitario = ko.computed( function() {
    return self.IdDetalleSaldoInicialCuentaCobranza ? "#input_PrecioUnitario_" + self.IdDetalleSaldoInicialCuentaCobranza() : "";
  },this);

  self.InputSubTotal = ko.computed( function() {
    return self.IdDetalleSaldoInicialCuentaCobranza ? "#input_SubTotal_" + self.IdDetalleSaldoInicialCuentaCobranza() : "";
  },this);

  self.InputFila = ko.computed( function() {
    return self.IdDetalleSaldoInicialCuentaCobranza ? "#tr_Detalle_" + self.IdDetalleSaldoInicialCuentaCobranza() : "";
  },this);
  ...
  self.Seleccionar = function (data, event) {
    if(event) {
      var id = "#"+ data.IdDetalleSaldoInicialCuentaCobranza()+"_tr_detalle";

VistaModeloDetalleCobranzaCliente = function (data, $parent) {
    var self = this;
    ...
    self.OnChangeMontoCobranza = function (data, event, detail) {
      if (event) {
        ...
        self.Cabecera.CalcularTotalComprobante(data, event, detail);
      }
    }

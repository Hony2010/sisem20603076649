ModeloDetalleCompraCostoAgregado = function (data) {
    var self = this;
    var base = data;
    ...
    self.Reemplazar = function(data) {
      if(data) {
        data.ValorVentaItem = data.ValorVentaItem === "" || data.ValorVentaItem === null ? "0.00" : data.CostoUnitario;
        var nuevodetalle = self.NuevoDetalleCompraCostoAgregado;
        ...
        var adicionaldata= {'ValorVentaItem' : "0.00",
                            'CostoUnitario' : "0.00",
                            'PrecioUnitario' : "0.00",
        ...
        ko.mapping.fromJS(nuevadata, MappingCompra.DetalleCompraCostoAgregado, copia);
        var resultado = new VistaModeloDetalleCompraCostoAgregado(copia);

VistaModeloVentaGeneralLubricante = function (data) {
  var self = this;
  ...
  self.DescargarReporte = function (datajs, event) {
    if (event) {
      ...
      $.ajax({
        ...
        data: datajs,
        dataType: "json",
        url: SITE_URL + '/Reporte/Venta/cVentaGeneralLubricante/' + nombre,
  ...
  self.MostrarReporte = function (datajs, event) {
    if (event) {
      ...
      $.ajax({
        ...
        data: datajs,
        dataType: "json",
        url: SITE_URL + '/Reporte/Venta/cVentaGeneralLubricante/GenerarReportePANTALLA',
        success: function (data) {
          if (data != "") {
...
var MappingVentaGeneralLubricante = {
  'Buscador': {
    create: function (options) {
      if (options)
        return new VistaModeloVentaGeneralLubricante(options.data);
    }
  }
}


IndexReporteVentaGeneralLubricante = function (data) {
    var self = this;
    ko.mapping.fromJS(data, MappingVentaGeneralLubricante, self);
}

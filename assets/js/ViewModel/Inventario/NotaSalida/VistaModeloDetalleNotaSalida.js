...
VistaModeloDetalleNotaSalida = function (data) {
  var self = this;
  ko.mapping.fromJS(data, MappingCatalogo, self);
  self.IdsDetalle = ko.observable([]);
  self.Cantidad = ko.observable(self.Cantidad() !== null && self.Cantidad() !== "" ? self.Cantidad() : self.SaldoPendienteSalida());
  ...
  ModeloDetalleNotaSalida.call(this, self);
  ...
  self.InputCodigoMercaderia = ko.computed(function () {
    if (self.IdDetalleNotaSalida != undefined) {
      return "#" + self.IdDetalleNotaSalida() + "_input_CodigoMercaderia";
    }
    else {
      return "";
    }
  ...
  self.InputProducto = ko.computed(function () {
    if (self.IdDetalleNotaSalida != undefined) {
      return "#" + self.IdDetalleNotaSalida() + "_input_NombreProducto";
    }
    else {
      return "";
    }
  ...
  self.InputCantidad = ko.computed(function () {
    if (self.IdDetalleNotaSalida != undefined) {
      return "#" + self.IdDetalleNotaSalida() + "_input_Cantidad";
    }
    else {
      return "";
    }
  ...
  self.InputValorUnitario = ko.computed(function () {
    if (self.IdDetalleNotaSalida != undefined) {
      return "#" + self.IdDetalleNotaSalida() + "_input_ValorUnitario";
    }
    else {
      return "";
    }
  ...
  self.InputDescuentoItem = ko.computed(function () {
    if (self.IdDetalleNotaSalida != undefined) {
      return "#" + self.IdDetalleNotaSalida() + "_input_DescuentoItem";
    }
    else {
      return "";
    }
  ...
  self.InputOpcion = ko.computed(function () {
    if (self.IdDetalleNotaSalida != undefined) {
      return "#" + self.IdDetalleNotaSalida() + "_a_opcion";
    }
    else {
      return "";
    }
  ...
  self.ValidarCantidad = function (data, event) {
    if (event) {
      ...
      if (window.Motivo.Reglas.DocumentoReferencia == 1) {
        if (parseFloat(data.Cantidad()) > parseFloat(self.SaldoPendienteSalida())) {
          data.Cantidad(self.SaldoPendienteSalida());

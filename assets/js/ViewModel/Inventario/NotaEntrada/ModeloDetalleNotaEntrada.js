ModeloDetalleNotaEntrada = function (data) {
    var self = this;
    var base = data;
    ...
    self.Reemplazar = function(data) {
      if(data) {
        ...
        var nuevodetalle = self.NuevoDetalleNotaEntrada;
        ...
        var adicionaldata= { 'SaldoPendienteEntrada':  "0.00" ,
                              // 'Cantidad':  $cantidad ,
                             // 'DescuentoItem' : $descuentoitem,
                             'ValorUnitario':  "0.00" ,
                             'IdDetalleNotaEntrada' : self.IdDetalleNotaEntrada()  };
        ko.mapping.fromJS(adicionaldata, {} , copia);
        ko.mapping.fromJS(nuevadata, MappingInventario.DetalleNotaEntrada, copia);
        var resultado = new VistaModeloDetalleNotaEntrada(copia);

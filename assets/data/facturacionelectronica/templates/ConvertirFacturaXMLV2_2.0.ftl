  ...
  <cac:Party>
    ...
    <cac:PartyLegalEntity>
      ...
      <cac:RegistrationAddress>
        <cac:AddressLine>
          <cbc:Line>${direccionDomFiscalSwf}</cbc:Line>
        </cac:AddressLine>
        <cbc:CitySubdivisionName>${Zona}</cbc:CitySubdivisionName>
        <cbc:CityName>${NombreProvincia}</cbc:CityName>
        <cbc:ID>${codigoUbigeo}</cbc:ID>
        <cbc:CountrySubEntity>${nombreDepartamento}</cbc:CountrySubEntity>
        <cbc:District>${nombreDistrito}</cbc:District>
        <cac:Country>
            <cbc:IdentificationCode>
              ${CodigoPais}
            </cbc:IdentificationCode>
        </cac:Country>
        <cbc:AddressTypeCode>${CodigoSede}</cbc:AddressTypeCode>
      </cac:RegistrationAddress>
    </cac:PartyLegalEntity>
  </cac:Party>
</cac:AccountingSupplierParty>
...
<cac:AccountingCustomerParty>
  <cac:Party>
    <cac:PartyIdentification>
      <cbc:ID schemeID="${tipoDocumento}">${nroDocumento}</cbc:ID>
    </cac:PartyIdentification>

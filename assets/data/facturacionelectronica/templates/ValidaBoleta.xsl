...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" 
	...
	xmlns:dp="http://www.datapower.com/extensions" version="2.0">
    ...
    <xsl:template match="/*">
        ...
        <xsl:if test="count($sacAdditionalInformation)>1">
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2427'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2427)'" /> </xsl:call-template>
        </xsl:if>
        ...
        <xsl:if test="$sacSUNATTransactionID">
            ...
            <xsl:if test="$sacSUNATTransactionID[text() = '04'] and not(cac:InvoiceLine/cac:Item/cbc:Description and cac:InvoiceLine/cbc:LineExtensionAmount)">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2500'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2500)'" /> </xsl:call-template>
            </xsl:if>
			...
			<xsl:if test="$sacSUNATTransactionID[text() = '04'] and (cac:InvoiceLine/cbc:LineExtensionAmount[text()&lt;=0])">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2501'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2501)'" /> </xsl:call-template>
            </xsl:if>
            ...
            <xsl:if test="$sacSUNATTransactionID[text() = '04'] and $additionalMonetaryTotalID[text()='1001'] and (cac:TaxTotal/cbc:TaxAmount[text() &lt;=0] or cac:LegalMonetaryTotal/cbc:PayableAmount[text() &lt;=0])">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2502'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2502)'" /> </xsl:call-template>
            </xsl:if>
        </xsl:if>
        ...
        <xsl:for-each select="cac:PrepaidPayment">
            ...
            <xsl:if test="./cbc:PaidAmount and ./cbc:PaidAmount &lt;= 0 ">
                ...
                <xsl:message terminate="no" >
                    <xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2503)'"/>
                </xsl:message>
            </xsl:if>
            <!--JorgeS 180315 fin -->
            ...
            <xsl:if test="./cbc:PaidAmount and not(./cbc:ID and ./cbc:InstructionID)">
                ...
                <!--<xsl:message terminate="yes" > -->
                <xsl:message terminate="no" >
                    <xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2504)'"/>
                </xsl:message>
            </xsl:if>
            <!--JorgeS 180315 fin -->
            <!--JorgeS 180315 inicio -->
            ...
            <xsl:if test="./cbc:ID/@schemeID and not(./cbc:ID/@schemeID != '')">
                ...
                <!--<xsl:message terminate="yes" > -->
                <xsl:message terminate="no" >
                    <xsl:value-of select="'Error Expr Regular BOLETA (codigo: 1041)'"/>
                </xsl:message>
            </xsl:if>
            <!--JorgeS 180315 fin -->
            ...
            <xsl:if test="./cbc:ID and ./cbc:ID/@schemeID !='02' and ./cbc:ID/@schemeID !='03'">
                ...
                <!--<xsl:message terminate="yes" >-->
                <xsl:message terminate="no" >
                    <xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2505)'"/>
                </xsl:message>
            </xsl:if>
            <!--JorgeS 180315 fin -->
            <!-- Inicio js 130515-->
            <xsl:choose>
                <xsl:when test="./cbc:InstructionID/@schemeID">
                    ...
                    <!-- 					<xsl:if
						test='not(matches(./cbc:ID,"^[F][A-Z0-9]{3}-[0-9]{1,8}$|^(E001)-[0-9]{1,8}$|^[B][A-Z0-9]{3}-[0-9]{1,8}$|^(EB01)-[0-9]{1,8}$"))'>   -->
                    <!--<xsl:call-template name="throwError">-->
                    <!-- 						<xsl:call-template name="throwError">
						...
						<xsl:message terminate="yes" > -->
                    <!-- 						<xsl:message terminate="yes" >
							<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2506)'" />
						</xsl:message>
					</xsl:if>	 -->
                    <xsl:if test="./cbc:ID/@schemeID ='02' and not(matches(./cbc:ID,'^[F][A-Z0-9]{3}-[0-9]{1,8}$|^(E001)-[0-9]{1,8}$|^[0-9]{1,4}-[0-9]{1,8}$'))">
                    ...
                    <xsl:if test="./cbc:ID/@schemeID ='03' and not(matches(./cbc:ID,'^[B][A-Z0-9]{3}-[0-9]{1,8}$|^[0-9]{1,4}-[0-9]{1,8}$'))">
                        <xsl:call-template name="addWarning"> <xsl:with-param name="warningCode" select="'2521'"/> <xsl:with-param name="warningMessage" select="concat('documento: ', position())"/></xsl:call-template>
                    </xsl:if>
                    ...
                    <xsl:if test="not(matches(./cbc:InstructionID,'^[0-9]{11}$'))">
                        <xsl:call-template name="addWarning"> <xsl:with-param name="warningCode" select="'2521'"/> <xsl:with-param name="warningMessage" select="concat('documento: ', position())"/></xsl:call-template>
                    </xsl:if>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:if test="./cbc:InstructionID">
                        ...
                        <xsl:if test="not(matches(./cbc:InstructionID,'^[F][A-Z0-9]{3}-[0-9]{1,8}$|^(E001)-[0-9]{1,8}$|^[0-9]{1,4}-[0-9]{1,8}$'))">
                            <!--				test="not(matches(./cbc:InstructionID,'^[0-9]{11}$|^[-]{1}$'))"> -->
		...
		<xsl:choose>
		    <xsl:when test="$PrepaidPaymentId02GreaterThan0">
                <xsl:if test="cac:LegalMonetaryTotal/cbc:PrepaidAmount and not(matches(cac:LegalMonetaryTotal/cbc:PrepaidAmount,'^[0-9]{1,12}(\.[0-9]{1,2})?$'))">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2509'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2509 -1)'" /> </xsl:call-template>
                </xsl:if>
                <xsl:if test="number(cac:LegalMonetaryTotal/cbc:PrepaidAmount) != number(round(100*$acumPrepaid) div 100)">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2509'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2509 -2)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='cac:LegalMonetaryTotal/cbc:PrepaidAmount and cac:LegalMonetaryTotal/cbc:PrepaidAmount &lt;= 0'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2508'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2508)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <!-- 		<xsl:if test="cac:LegalMonetaryTotal/cbc:PrepaidAmount and (number(cac:LegalMonetaryTotal/cbc:PrepaidAmount) != number($acumPrepaid))">
			...
			<xsl:message terminate="yes" >
				<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2509)'" />
			</xsl:message>
		</xsl:if> -->
        ...
        <!-- Validar que la serie y numero del documento de anticipo corresponda 
			...
			<xsl:message terminate="yes" > <xsl:value-of select="'Error 
        ...
        <xsl:choose>
		     <xsl:when test="not(string(cac:AccountingSupplierParty/cbc:CustomerAssignedAccountID))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'1006'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 1006)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(cac:AccountingSupplierParty/cbc:CustomerAssignedAccountID,"^[0-9]{11}$"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'1005'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 1005)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            <xsl:when test="not(string(cbc:ID))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'1002'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 1002)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(cbc:ID,"^[B][A-Z0-9]{3}-[0-9]{1,8}?$"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'1001'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 1001)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            <xsl:when test="not(string(cbc:InvoiceTypeCode))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'1004'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 1004)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(cbc:InvoiceTypeCode,"^(03)$"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'1003'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 1003)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            <xsl:when test="not(string(cbc:CustomizationID))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2073'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2073)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(cbc:CustomizationID,"^[0-9]{1,7}(\.[0-9]{1,2})?$"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2072'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2072)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            <xsl:when test="not(string(cbc:UBLVersionID))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2075'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2075)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(cbc:UBLVersionID,"^[2]{1}(\.[0]{1})$"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2074'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2074)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <!-- 			<xsl:if
								...
								<xsl:message terminate="yes" >
									<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 4046)'" />
								</xsl:message>
							</xsl:if>	 -->
        ...
        <!-- 			<xsl:if
							...
							<xsl:message terminate="yes" >
								<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 4039)'" />
							</xsl:message>
						</xsl:if> -->
        ...
        <xsl:if test="not(string(cac:AccountingSupplierParty/cbc:AdditionalAccountID))">
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'1008'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 1008)'" /> </xsl:call-template>
        </xsl:if>
        <xsl:if test='not(matches(cac:AccountingSupplierParty/cbc:AdditionalAccountID,"^[6]{1}$"))'>
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'1007'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 1007)'" /> </xsl:call-template>
        </xsl:if>
        <xsl:if test="count(cac:AccountingSupplierParty/cbc:AdditionalAccountID)>1">
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2362'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2362)'" /> </xsl:call-template>
        </xsl:if>
        <!-- Tipo de moneda en la cual se emite la factura electronica -->
        <xsl:choose>
            <xsl:when test="not(string(cbc:DocumentCurrencyCode))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2070'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2070)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(cbc:DocumentCurrencyCode,"^[A-Z]{3}$"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2069'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2069)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        ...
        <xsl:choose>
            <xsl:when test="not(string(cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'1037'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 1037)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(cac:AccountingSupplierParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName,"^[\p{L}\s]{3,1000}"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'1038'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 1038)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        
		<!-- Si existe el tag del adquiriente -->
        <xsl:if test="cac:AccountingCustomerParty/cbc:AdditionalAccountID">
            <!-- Valida que el numero de documento del adquirente existe -->
        
            <xsl:if test="not(string(cac:AccountingCustomerParty/cbc:CustomerAssignedAccountID))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2014'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2014)'" /> </xsl:call-template>
            </xsl:if>
	        
	        <!-- el tipo de documento tiene que ser del catalogo X, menos 6 -->
	        <xsl:if test='not(matches(cac:AccountingCustomerParty/cbc:AdditionalAccountID,"^[01467A\-]{1}$"))'>
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2016'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2016)'" /> </xsl:call-template>
            </xsl:if>
        ...
        <xsl:if test="count(cac:AccountingCustomerParty/cbc:AdditionalAccountID)>1">
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2363'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2363)'" /> </xsl:call-template>
        </xsl:if>
        ...
        <xsl:choose>
            <xsl:when test="not(cac:LegalMonetaryTotal/cbc:PayableAmount)">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2063'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2063)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(cac:LegalMonetaryTotal/cbc:PayableAmount,"^[0-9]{1,12}(\.[0-9]{1,10})?$"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2062'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2062)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
	   ...
	   <!-- Sumatoria otros Cargos -->
        <xsl:if test="cac:LegalMonetaryTotal/cbc:ChargeTotalAmount">
            <xsl:if test='not(matches(cac:LegalMonetaryTotal/cbc:ChargeTotalAmount,"^[0-9]{1,12}(\.[0-9]{1,2})?$"))'>
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2064'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2064)'" /> </xsl:call-template>
            </xsl:if>
        </xsl:if>
        ...
        <xsl:if test="cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount">
            ...
            <xsl:if test='not(matches(cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount,"^[0-9]{1,12}(\.[0-9]{1,2})?$"))'>
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2065'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2065)'" /> </xsl:call-template>
            </xsl:if>
            <!-- fin mover al detalle -->
            <xsl:if test='not(matches(cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount,"^[0-9]{1,12}(\.[0-9]{1,2})?$"))'>
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2419'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2419)'" /> </xsl:call-template>
            </xsl:if>
        </xsl:if>
        ...
        <xsl:for-each select="cac:DespatchDocumentReference">
            ...
            <xsl:if test="./cbc:DocumentTypeCode">
                <xsl:choose>
                    <xsl:when test='not(matches(./cbc:DocumentTypeCode,"^[0-9]{2}$"))'>
            ...
            <xsl:if test="./cbc:DocumentTypeCode">
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:if test='not(matches(./cbc:ID,"^(.){1,}-[0-9]{1,}$"))'>
        ...
        <xsl:for-each select="cac:DespatchDocumentReference">
            <xsl:if test="count(key('by-document-despatch-reference', concat(./cbc:DocumentTypeCode,' ',./cbc:ID))) > 1">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2364'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA  (codigo: 2364)'" /> </xsl:call-template>
            </xsl:if>
        </xsl:for-each>
	    ...
	    <!-- <xsl:if test="cac:DespatchDocumentReference/cbc:DocumentTypeCode">
			<xsl:if
				...
				<xsl:message terminate="yes" >
					<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2364)'" />
				</xsl:message>
			</xsl:if>
		</xsl:if> -->
        ...
        <xsl:for-each select="cac:AdditionalDocumentReference">
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>
                    <xsl:if test='./cbc:DocumentTypeCode and matches(./cbc:ID,"^(/^$|\s+/).{1,100}")'>
            ...
            <!-- <xsl:if
				...
				<xsl:message terminate="yes" >
					<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2365)'" />
				</xsl:message>
			</xsl:if>-->
        </xsl:for-each>
	   ...
	   <!-- Se incluyo bloque en un For, como en Validador Java - Fin -->
	    <xsl:for-each select="cac:AdditionalDocumentReference">
            <xsl:if test="count(key('by-document-additional-reference', concat(./cbc:DocumentTypeCode,' ',./cbc:ID))) > 1">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2365'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA  (codigo: 2365)'" /> </xsl:call-template>
            </xsl:if>
        </xsl:for-each>
        <!-- Se incluyo bloque en un For, como en Validador Java - Fin -->
        ...
        <xsl:if test="cac:TaxTotal/cbc:TaxAmount">
            <xsl:choose>
                <xsl:when test="not(string((cac:TaxTotal/cbc:TaxAmount)[1]))">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2049'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2049)'" /> </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:if test='not(matches((cac:TaxTotal/cbc:TaxAmount)[1],"^[0-9]{1,12}(\.[0-9]{1,2})?$"))'>
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2048'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2048)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:otherwise>
            </xsl:choose>
            <xsl:for-each select="cac:TaxTotal">
                <xsl:if test='./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID=1000'>
                    <xsl:if test="count(./cbc:TaxAmount)>1">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2352'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2352)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:if>
                <xsl:if test='./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID=2000'>
                    <xsl:if test="count(./cbc:TaxAmount)>1">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2353'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2353)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:if>
                <xsl:if test='./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID=9999'>
                    <xsl:if test="count(./cbc:TaxAmount)>1">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2354'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2354)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:if>
            </xsl:for-each>
        </xsl:if>
        ...
        <xsl:if test="$taxSubtotalTaxCategoryTaxScheme">
            <xsl:choose>
                <xsl:when test="not($taxSubtotalTaxCategoryTaxScheme/cbc:ID)">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2052'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2052)'" /> </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:if test='not(matches(($taxSubtotalTaxCategoryTaxScheme/cbc:ID)[1],"^[0-9]{4}$"))'>
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2050'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2050)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:otherwise>
            </xsl:choose>
            <xsl:if test="not((($taxSubtotalTaxCategoryTaxScheme/cbc:ID)='1000') or (($taxSubtotalTaxCategoryTaxScheme/cbc:ID)='2000') or (($taxSubtotalTaxCategoryTaxScheme/cbc:ID)='9999'))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2051'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2051)'" /> </xsl:call-template>
            </xsl:if>
            <xsl:choose>
                <xsl:when test="not($taxSubtotalTaxCategoryTaxScheme/cbc:Name)">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2054'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2054)'" /> </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                    <!--<xsl:if test='not(matches($taxSubtotalTaxCategoryTaxScheme/cbc:Name,"^(?!\s*$)[^\s]{3,1000}"))'>-->
                    <xsl:if test='matches(($taxSubtotalTaxCategoryTaxScheme/cbc:Name)[1],"(/^$|\s+/){3,1000}")'>
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2053'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2053)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:otherwise>
            </xsl:choose>
            <!-- Campo opcional, Antes expresion regular era ^(?!\s*$)[^\s]{3,100}$ -->
            <xsl:if test='$taxSubtotalTaxCategoryTaxScheme/cbc:TaxTypeCode and not(matches(($taxSubtotalTaxCategoryTaxScheme/cbc:TaxTypeCode)[1],"^(\s*$)|(.*)?[^\s]{3,100}"))'>
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2055'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2055)'" /> </xsl:call-template>
            </xsl:if>
            <!-- MAguilar 03062016 -->
            ...
            <xsl:if test="(($taxSubtotalTaxCategoryTaxScheme/cbc:ID=1000) and $taxSubtotalTaxCategoryTaxScheme/cbc:TaxTypeCode !='' and $taxSubtotalTaxCategoryTaxScheme/cbc:TaxTypeCode and not($taxSubtotalTaxCategoryTaxScheme/cbc:Name='IGV' or $taxSubtotalTaxCategoryTaxScheme/cbc:Name='IVAP'))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2057'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2057)'" /> </xsl:call-template>
            </xsl:if>
            ...
            <xsl:if test="(($taxSubtotalTaxCategoryTaxScheme/cbc:ID=2000) and $taxSubtotalTaxCategoryTaxScheme/cbc:TaxTypeCode !='' and $taxSubtotalTaxCategoryTaxScheme/cbc:TaxTypeCode and not($taxSubtotalTaxCategoryTaxScheme/cbc:Name='ISC'))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2058'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2058)'" /> </xsl:call-template>
            </xsl:if>
            ...
            <xsl:for-each select="cac:TaxTotal">
                <xsl:choose>
                    <xsl:when test="not(string(./cac:TaxSubtotal/cbc:TaxAmount))">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2060'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2060)'" /> </xsl:call-template>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:if test='not(matches(./cac:TaxSubtotal/cbc:TaxAmount,"^[0-9]{1,12}(\.[0-9]{1,2})?$"))'>
                            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2059'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2059)'" /> </xsl:call-template>
                        </xsl:if>
                    </xsl:otherwise>
                </xsl:choose>
                <xsl:if test="number(./cac:TaxSubtotal/cbc:TaxAmount)!=number(./cbc:TaxAmount)">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2061'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2061)'" /> </xsl:call-template>
                </xsl:if>
		...
		<xsl:if test="(cbc:DocumentCurrencyCode!=$sacAdditionalInformation/sac:AdditionalMonetaryTotal/cbc:ID[text()!='2001']/../cbc:PayableAmount/@currencyID)">
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2071'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2071)'" /> </xsl:call-template>
        </xsl:if>
		...
		<xsl:if
			...
			<xsl:message terminate="yes" >
				<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2071)'" />
			</xsl:message>
		</xsl:if>
		-->
     ...
     <!--
        <xsl:choose>
            <xsl:when test="not((cac:Signature/cbc:ID))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2076'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2076)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                    <xsl:if test='not(matches(cac:Signature/cbc:ID,"^[\p{L}\s]{2,3000}"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2077'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2077)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        <xsl:if test="not(cac:Signature/cac:SignatoryParty/cac:PartyIdentification/cbc:ID)">
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2079'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2079)'" /> </xsl:call-template>
        </xsl:if>
        <xsl:if test="(cac:Signature/cac:SignatoryParty/cac:PartyIdentification/cbc:ID != cac:AccountingSupplierParty/cbc:CustomerAssignedAccountID)">
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2078'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2078)'" /> </xsl:call-template>
        </xsl:if>
        <xsl:choose>
            <xsl:when test="not(cac:Signature/cac:SignatoryParty/cac:PartyName/cbc:Name)">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2081'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2081)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(cac:Signature/cac:SignatoryParty/cac:PartyName/cbc:Name,"^(?!\s*$).{2,3000}"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2080'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2080)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        <xsl:choose>
            <xsl:when test="not(cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference/cbc:URI)">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2083'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2083)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(cac:Signature/cac:DigitalSignatureAttachment/cac:ExternalReference/cbc:URI,"^(?!\s*$).{2,3000}"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2082'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2082)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
		<xsl:choose>
            <xsl:when test="not((ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/@Id))">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2085'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2085)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/@Id,"^(?!\s*$).{2,3000}"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2084'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2084)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        <xsl:choose>
            <xsl:when test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignedInfo/ds:CanonicalizationMethod/@Algorithm)">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2087'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2087)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignedInfo/ds:CanonicalizationMethod/@Algorithm,"^(?!\s*$).{2,3000}"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2086'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2086)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        <xsl:choose>
            <xsl:when test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignedInfo/ds:SignatureMethod/@Algorithm)">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2089'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2089)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignedInfo/ds:SignatureMethod/@Algorithm,"^(?!\s*$).{2,3000}"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2088'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2088)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        <xsl:choose>
            <xsl:when test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignedInfo/ds:Reference/@URI)">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2091'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2091)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='string(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignedInfo/ds:Reference/@URI)'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2090'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2090)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        <xsl:choose>
            <xsl:when test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignedInfo/ds:Reference/ds:Transforms/ds:Transform/@Algorithm)">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2093'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2093)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignedInfo/ds:Reference/ds:Transforms/ds:Transform/@Algorithm,"^(?!\s*$).{2,3000}"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2092'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2092)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        <xsl:choose>
            <xsl:when test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignedInfo/ds:Reference/ds:DigestMethod/@Algorithm)">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2095'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2095)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignedInfo/ds:Reference/ds:DigestMethod/@Algorithm,"^(?!\s*$).{2,3000}"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2094'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2094)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        <xsl:choose>
            <xsl:when test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignedInfo/ds:Reference/ds:DigestValue)">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2097'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2097)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
			</xsl:otherwise>
        </xsl:choose>
        <xsl:choose>
            <xsl:when test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignatureValue)">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2099'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2099)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:SignatureValue,"[A-Za-z0-9+/=\s]{2,}"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2098'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2098)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
        <xsl:choose>
            <xsl:when test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:KeyInfo/ds:X509Data/ds:X509Certificate)">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2101'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2101)'" /> </xsl:call-template>
            </xsl:when>
            <xsl:otherwise>
                <xsl:if test='not(matches(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/ds:Signature/ds:KeyInfo/ds:X509Data/ds:X509Certificate,"[A-Za-z0-9+/=\s]{2,}"))'>
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2100'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2100)'" /> </xsl:call-template>
                </xsl:if>
            </xsl:otherwise>
        </xsl:choose>
		-->
        ...
        <xsl:for-each select="cac:InvoiceLine">
            ...
            <xsl:choose>
                <xsl:when test="not(./cbc:ID)">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2023'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2023)'" /> </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:if test='not(matches(./cbc:ID,"^[0-9]{1,3}?$")) or ./cbc:ID &lt;= 0'>
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2023'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2023)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:otherwise>
            </xsl:choose>
            ...
            <xsl:choose>
                <xsl:when test="not(string(./cbc:InvoicedQuantity))">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2024'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2024)'" /> </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:if test='not(matches(./cbc:InvoicedQuantity,"^[0-9]{1,12}(\.[0-9]{1,10})?$"))'>
                        <!-- 17/09/2014 se corrigio la cantidad de decimales, decia 3 -->
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2025'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2025)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:otherwise>
            </xsl:choose>
            ...
            <xsl:choose>
                <xsl:when test="not(./cac:Item/cbc:Description)">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2026'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2026)'" /> </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                    <!--<xsl:if test='not(matches(./cac:Item/cbc:Description,"^(?!\s*$).{1,250}"))'>-->
                    <xsl:if test='matches(./cac:Item/cbc:Description,"^(/^$|\s+/){1,250}")'>
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2027'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2027)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:otherwise>
            </xsl:choose>
            ...
            <xsl:for-each select="./cac:PricingReference/cac:AlternativeConditionPrice">
                <xsl:choose>
                    <xsl:when test="(./cbc:PriceTypeCode)=01 and (not(string(./cbc:PriceAmount)))">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2028'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2028)'" /> </xsl:call-template>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:if test='(./cbc:PriceTypeCode)=01 and not(matches(./cbc:PriceAmount,"^[0-9]{1,12}(\.[0-9]{1,10})?$"))'>
                            <!-- 17/09/2014 se corrigio la cantidad de decimales a 10 -->
                            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2367'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2367)'" /> </xsl:call-template>
                        </xsl:if>
                    </xsl:otherwise>
                </xsl:choose>
                <!-- Precio de venta unitario por item -->
                <xsl:if test="(count(./cbc:PriceTypeCode[text()='01'])>1 or count(./cbc:PriceTypeCode[text()='02'])>1)">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2409'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2409)'" /> </xsl:call-template>
                </xsl:if>
                <xsl:if test="not(./cbc:PriceTypeCode=01 or ./cbc:PriceTypeCode=02)">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2410'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2410)'" /> </xsl:call-template>
                </xsl:if>
                ...
                <xsl:choose>
                    <xsl:when test="(./cbc:PriceTypeCode)=02 and (not(string(./cbc:PriceAmount)))">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2417'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2417)'" /> </xsl:call-template>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:if test='(./cbc:PriceTypeCode)=02 and not(matches(./cbc:PriceAmount,"^[0-9]{1,12}(\.[0-9]{1,10})?$"))'>
                            <!-- 16/01/2014 se corrigio la cantidad de decimales, decia 10 lo correcto es 2 -->
                            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2408'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2408)'" /> </xsl:call-template>
                        </xsl:if>
                    </xsl:otherwise>
                </xsl:choose>
                <!-- <xsl:if test='(./cbc:PriceTypeCode)=02 and (./cbc:PriceAmount<0 
					...
					/> </xsl:call-template> <xsl:message terminate="yes" > 
					<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2418)'" /> </xsl:message> 
					</xsl:if> -->
            </xsl:for-each>
            ...
            <!-- xsl:choose>
						<xsl:when test="(./cbc:PriceTypeCode)=02 and (not(string(./cbc:PriceAmount)))">
							...
							<xsl:message terminate="yes" >
								<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2417)'" />
							</xsl:message>
						</xsl:when>
						<xsl:otherwise>
							<xsl:if test='(./cbc:PriceTypeCode)=02 and not(matches(./cbc:PriceAmount,"^[0-9]{1,12}(\.[0-9]{1,2})?$"))'>
								<xsl:call-template name="throwError">
									<xsl:with-param name="codigo" select="'2408'" />
								</xsl:call-template>
								<xsl:message terminate="yes" >
									<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2408)'" />
								</xsl:message>
							</xsl:if>
            ...
            <!-- Valor referencial unitario por item en operaciones no onerosas y codigo -->
            <!-- xsl:choose>
					<xsl:when test='(./cbc:PriceTypeCode)=02 and not(matches(./cbc:PriceAmount,"^[0-9]{1,12}(\.[0-9]{1,2})?$"))'>
						<xsl:call-template name="throwError">
							<xsl:with-param name="codigo" select="'2408'" />
						</xsl:call-template>
						<xsl:message terminate="yes" >
					...
					<xsl:otherwise>						
						<xsl:if test='(./cbc:PriceTypeCode)=02 and (./cbc:PriceAmount[text()&gt;0]) and not($debehabervalorreferencial)'>
							...
							<xsl:message terminate="yes" >
								<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2418)'" />
							</xsl:message>
						</xsl:if>
					</xsl:otherwise>
				</xsl:choose>
            ...
            <xsl:choose>
                <xsl:when test="not(./cac:Price/cbc:PriceAmount)">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2068'" /> <xsl:with-param name="errorMessage" select="concat('Error Expr Regular BOLETA (codigo: 2068) line: ', cbc:ID)" /> </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                    <!-- Valor unitario por item -->
                    <xsl:if test='matches(./cac:Price/cbc:PriceAmount,"^[\s]+$")'>
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2067'" /> <xsl:with-param name="errorMessage" select="concat('Error Expr Regular BOLETA (codigo: 2067) line: ', cbc:ID)" /> </xsl:call-template>
                    </xsl:if>
                    <xsl:if test='not(matches(./cac:Price/cbc:PriceAmount,"^[0-9]{1,12}(\.[0-9]{1,10})?$"))'>
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2369'" /> <xsl:with-param name="errorMessage" select="concat('Error Expr Regular BOLETA (codigo: 2369) line: ', cbc:ID)" /> </xsl:call-template>
                    </xsl:if>
                </xsl:otherwise>
            </xsl:choose>
            <xsl:choose>
                <xsl:when test="not(./cbc:LineExtensionAmount)">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2032'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2032)'" /> </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                    <!-- Valor de venta por item -->
                    <xsl:if test='matches(./cbc:LineExtensionAmount,"^[\s]+$")'>
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2031'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2031)'" /> </xsl:call-template>
                    </xsl:if>
                    <xsl:if test='not(matches(./cbc:LineExtensionAmount,"(-?[0-9]+){1,12}(\.[0-9]{1,2})?$"))'>
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2370'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2370)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:otherwise>
            </xsl:choose>
			...
			<xsl:if test="count(./cac:PricingReference/cac:AlternativeConditionPrice/cbc:PriceAmount[text()>0 and parent::node()/cbc:PriceTypeCode=02])>0 
				...
				<xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2425'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2425)'" /> </xsl:call-template>
			</xsl:if>			
            ...
            <xsl:for-each select="./cac:TaxTotal">
                <xsl:if test='./cbc:TaxAmount'>
                    <xsl:choose>
                        <xsl:when test="not(string(./cbc:TaxAmount))">
                            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2034'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2034)'" /> </xsl:call-template>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:if test='not(matches(./cbc:TaxAmount,"^[0-9]{1,12}(\.[0-9]{1,2})?$"))'>
                                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2033'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2033)'" /> </xsl:call-template>
                            </xsl:if>
                        </xsl:otherwise>
                    </xsl:choose>
                    <xsl:if test="./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID=1000 and count(./cbc:TaxAmount)>1">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2355'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2355)'" /> </xsl:call-template>
                    </xsl:if>
                    <xsl:if test="./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID=2000 and count(./cbc:TaxAmount)>1">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2356'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2356)'" /> </xsl:call-template>
                    </xsl:if>
                    <xsl:if test="number(./cbc:TaxAmount)!=number(./cac:TaxSubtotal/cbc:TaxAmount)">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2372'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2372)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:if>
                <xsl:choose>
                    <xsl:when test="not(./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID)">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2037'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2037)'" /> </xsl:call-template>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:if test='not(matches(./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID,"^[0-9]{4}$"))'>
                            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2035'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2035)'" /> </xsl:call-template>
                        </xsl:if>
                    </xsl:otherwise>
                </xsl:choose>
                <xsl:if test="not(./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID[text()=1000 or text()=2000 or text()=9999])">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2036'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2036)'" /> </xsl:call-template>
                </xsl:if>
                <xsl:if test='./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID=1000'>
                    <xsl:choose>
                        <xsl:when test="not(./cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReasonCode)">
                            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2371'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2371)'" /> </xsl:call-template>
                        </xsl:when>
                        <xsl:otherwise>
							<!--27/10/2015-Maguilar - IVAP /inicio 
                            <xsl:if test="not(./cac:TaxSubtotal/cac:TaxCategory/cbc:TaxExemptionReasonCode[text() = '10' or text() = '11' or text() = '12' or text() = '13' or text() = '14' or text() = '15' or text() = '16' or text() = '20' or text() = '21' or text() = '30' or text() = '31' or text() = '32' or text() = '33' or text() = '34' or text() = '35' or text() = '36' or text() = '40'])">
                                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2040'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2040)'" /> </xsl:call-template>
                            </xsl:if>
                ...
                <xsl:choose>
                    <xsl:when test="not(./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:Name)">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2038'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2038)'" /> </xsl:call-template>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:if test='not(matches(./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:Name,"^[A-Z]{3,1000}?$"))'>
                            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2038'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2038)'" /> </xsl:call-template>
                        </xsl:if>
                    </xsl:otherwise>
                </xsl:choose>
                <xsl:if test='./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID'>
                    <xsl:if test='./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID=1000'>
                        <xsl:if test="./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:Name and ./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:Name !='' and (not(./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:Name='IGV') and not(./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='VAT'))">
                            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2377'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2377)'" /> </xsl:call-template>
                        </xsl:if>
                    </xsl:if>
                    <xsl:if test='./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID=2000'>
                        <xsl:if test="./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:Name and ./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:Name !='' and (not(./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:Name='ISC') and not(./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode='EXC'))">
                            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2378'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2378)'" /> </xsl:call-template>
                        </xsl:if>
                    </xsl:if>
                </xsl:if>
                <xsl:if test="./cac:TaxSubtotal/cbc:TaxAmount">
                    <xsl:choose>
                        <xsl:when test="./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID=1000 and not(string(./cac:TaxSubtotal/cbc:TaxAmount))">
                            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2042'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2042)'" /> </xsl:call-template>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:if test='not(matches(./cac:TaxSubtotal/cbc:TaxAmount,"^[0-9]{1,12}(\.[0-9]{1,2})?$"))'>
                                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2368'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2368)'" /> </xsl:call-template>
                            </xsl:if>
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:if>
                <xsl:if test='./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID=2000'>
                    <xsl:if test="not(string(./cac:TaxSubtotal/cac:TaxCategory/cbc:TierRange))  and ./cac:TaxTotal/cbc:TaxAmount > 0">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2373'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2373)'" /> </xsl:call-template>
                    </xsl:if>
                    <xsl:if test="./cac:TaxSubtotal/cac:TaxCategory/cbc:TierRange and not(./cac:TaxSubtotal/cac:TaxCategory/cbc:TierRange[text()='' or text()=01 or text()=02 or text()=03])">
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2041'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2041)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:if>
            </xsl:for-each>
            ...
            <!-- se quito puesto que la validacion no existe en el sistema anterior 
				...
				terminate="yes" > <xsl:value-of select="'Error Expr Regular 
            ...
            <!-- <xsl:otherwise> <xsl:if test="./cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount&lt;=0"> 
				...
				/> </xsl:call-template> <xsl:message terminate="yes" > 
				<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2368)'" /> </xsl:message> 
			...
			<xsl:for-each select="cac:TaxTotal">				
				<xsl:if test='./cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID=2000'>
					<xsl:if test="(count(./cbc:TaxAmount)=1) and (./cbc:TaxAmount[text() &lt;=0])">
						...
						<xsl:message terminate="yes" >
							<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2423)'" />
						</xsl:message>
					</xsl:if>
				</xsl:if>
			</xsl:for-each>
            ...
            <xsl:if test="$sacSUNATTransactionID[text() = '06']">
                ...
                <xsl:if test="not($todoNulo)">
                    <xsl:if test="not(./cac:DeliveryAddress/cbc:ID != '' and ./cac:DeliveryAddress/cbc:StreetName != '' and ./cac:DeliveryAddress/cbc:CityName != '' 
                        ...
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2421'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2421)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:if>
                ...
                <!-- 					<xsl:if
						...
						<xsl:message terminate="yes" >
							<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2421 -1)'" />
						</xsl:message>
					</xsl:if> -->
                ...
                <!-- 					<xsl:if
						...
						<xsl:message terminate="yes" >
							<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2421 -2)'" />
						</xsl:message>
					</xsl:if> -->
                ...
                <xsl:if test="./cbc:GrossWeightMeasure">
                    ...
                    <xsl:if test="./cbc:GrossWeightMeasure &lt;= 0 or not(matches(./cbc:GrossWeightMeasure,'^[0-9]{1,12}(\.[0-9]{1,2})?$'))">
        ...
        <!-- Leyendas -->
        <xsl:if test="$sacAdditionalInformation/sac:AdditionalProperty/cbc:ID">
            <xsl:if test='not(matches(($sacAdditionalInformation/sac:AdditionalProperty/cbc:ID)[1],"^[^\s]{4}$"))'>
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2366'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2366)'" /> </xsl:call-template>
            </xsl:if>
            ...
            <xsl:if test="$AdditionalPropertyId1000GreaterThan1 or $AdditionalPropertyId1001GreaterThan1 or $AdditionalPropertyId1002GreaterThan1 or $AdditionalPropertyId2000GreaterThan1 or $AdditionalPropertyId2001GreaterThan1 or $AdditionalPropertyId2002GreaterThan1 or $AdditionalPropertyId2003GreaterThan1">
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2407'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2407)'" /> </xsl:call-template>
            </xsl:if>
        </xsl:if>
        <xsl:if test="$sacAdditionalInformation/sac:AdditionalProperty/cbc:Value">
            <xsl:if test='matches(($sacAdditionalInformation/sac:AdditionalProperty/cbc:Value)[1],"^(/^$|\s+/).{1,100}")'>
                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2066'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2066)'" /> </xsl:call-template>
            </xsl:if>
        </xsl:if>
        ...
        <xsl:for-each select="$additionalMonetaryTotal">
            <xsl:choose>
                <xsl:when test="not(string(./cbc:ID))">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2046'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2046)'" /> </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                    ...
                    <xsl:choose>
                        <xsl:when test='string-length($respParametro)=0'>
                            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2045'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2045)'" /> </xsl:call-template>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:if test="$sacSUNATTransactionID[text() = '04'] and (./cbc:ID[text() = '1001']) and (./cbc:PayableAmount[text()&lt;=0])">
                                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2502'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2502)'" /> </xsl:call-template>
                            </xsl:if>
                            <xsl:if test="(./cbc:ID[text() = '2005']) and (not(./cbc:PayableAmount) or not(matches(./cbc:PayableAmount,'^[0-9]{1,12}(\.[0-9]{1,2})?$')))">
                                <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2065'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2065)'" /> </xsl:call-template>
                            </xsl:if>
                        </xsl:otherwise>
                    </xsl:choose>
                    <!-- Se remplaza por parametro 741 -->
                    <!-- <xsl:if test='not(matches($additionalMonetaryTotalID,"^[0-9]{4}$"))'>
						<xsl:call-template name="throwError">
							<xsl:with-param name="codigo" select="'2045'" />
						</xsl:call-template>
						<xsl:message terminate="yes" >
							<xsl:value-of select="'Error Expr Regular BOLETA (codigo: 2045)'" />
						</xsl:message>
					</xsl:if>
					-->
                </xsl:otherwise>
        ...
        <xsl:if test="not(($additionalMonetaryTotalID[text()='1001' or text()='1002' or text()='1003' or text()='1004' or text()='3001']))">
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2047'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2047)'" /> </xsl:call-template>
        </xsl:if>
        <xsl:if test="(count($additionalMonetaryTotalID[text()='1001'])>1)">
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2349'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2349)'" /> </xsl:call-template>
        </xsl:if>
        <xsl:if test="(count($additionalMonetaryTotalID[text()='1002'])>1)">
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2350'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2350)'" /> </xsl:call-template>
        </xsl:if>
        <xsl:if test="(count($additionalMonetaryTotalID[text()='1003'])>1)">
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2351'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2351)'" /> </xsl:call-template>
        </xsl:if>
        ...
        <xsl:if test="(count($additionalMonetaryTotalID[text()='1001'])>1 or
            ...
            <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2406'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2406)'" /> </xsl:call-template>
        </xsl:if>
        <xsl:for-each select="$additionalMonetaryTotal">
            <xsl:choose>
                <xsl:when test="not(./cbc:PayableAmount)">
                    <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2044'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2044)'" /> </xsl:call-template>
                </xsl:when>
                <xsl:otherwise>
                    <xsl:if test='not(matches(./cbc:PayableAmount,"^[0-9]{1,12}(\.[0-9]{1,2})?$"))'>
                        <xsl:call-template name="rejectCall"> <xsl:with-param name="errorCode" select="'2043'" /> <xsl:with-param name="errorMessage" select="'Error Expr Regular BOLETA (codigo: 2043)'" /> </xsl:call-template>
                    </xsl:if>
                </xsl:otherwise>
            </xsl:choose>
        </xsl:for-each>
    ...
    <xsl:template name="getPrepaidPaymentAcum">
        ...
        <xsl:choose>
            <xsl:when test="$RemainingItems">
                <xsl:if test="$Item1/cbc:PaidAmount and (matches($Item1/cbc:PaidAmount,'^[0-9]{1,12}(\.[0-9]{1,2})?$') and $Item1/cbc:PaidAmount &gt; 0 )">
    ...
    <xsl:template name="parametro741">
        ...
        <!--<xsl:variable name="descripcionParam" select="document('D:/sunat_archivos/sfs/VALI/Catalogo741.xml')"/>-->
        <xsl:variable name="descripcionParam" select="document('util/Catalogo741.xml')"/>

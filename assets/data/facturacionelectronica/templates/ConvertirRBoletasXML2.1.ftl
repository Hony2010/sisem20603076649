...
<ext:UBLExtensions>
 ...
 <cac:AccountingSupplierParty>
  ...
  <sac:SummaryDocumentsLine>
    ...
    <#if resumen.tipDocResumen = '07' || resumen.tipDocResumen ='08' >
    ...
    <!--TOTAL ICBPER-->
    <#if (resumen.monTribICBPER?eval gt 0)>
    <cac:TaxTotal>
      <cbc:TaxAmount currencyID="${resumen.moneda}">${resumen.monTribICBPER}</cbc:TaxAmount>
      <cac:TaxSubtotal>
        <cbc:TaxAmount currencyID="${resumen.moneda}">${resumen.monTribICBPER}</cbc:TaxAmount>
        <cac:TaxCategory>
          <cac:TaxScheme>

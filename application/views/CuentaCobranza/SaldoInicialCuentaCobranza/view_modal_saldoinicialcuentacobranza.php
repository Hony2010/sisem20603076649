            ...
            <fieldset>
              <div class="" >
                <table class="datalist__table table display table-border grid-detail-body" width="100%" data-products="brand">
                  ...
                  <tbody>
                    <!-- ko foreach : DetallesSaldoInicialCuentaCobranza -->
                    <tr class="clickable-row text-uppercase" data-bind="attr: { id: 'tr_detalle_' + IdDetalleSaldoInicialCuentaCobranza() }, event{ }">
                      <td class="">
                        <input type="text" class="form-control formulario" data-bind="
                        value: CodigoMercaderia,
                        attr: { id: 'input_CodigoMercaderia_' + IdDetalleSaldoInicialCuentaCobranza() },
                      ...
                      <td class="">
                        ...
                        attr: { id: 'input_NombreProducto_' + IdDetalleSaldoInicialCuentaCobranza(), 'data-validation-reference': 'input_CodigoMercaderia_' + IdDetalleSaldoInicialCuentaCobranza() },
                      ...
                      <td class="">
                        ...
                        value: Cantidad,
                        attr: { id: 'input_Cantidad' + IdDetalleSaldoInicialCuentaCobranza(), 'data-cantidad-decimal': DecimalCantidad() },
                      ...
                      <td class="">
                        ...
                        attr: { id: 'input_PrecioUnitario' + IdDetalleSaldoInicialCuentaCobranza(), 'data-cantidad-decimal': DecimalPrecioUnitario() },
                      ...
                      <td class="">
                        <input type="text" class="form-control formulario text-right" data-bind="
                        value: SubTotal,
                        attr: { id: 'input_SubTotal' + IdDetalleSaldoInicialCuentaCobranza()},
                      ...
                      <td width="40">
                        ...
                        attr : { id : 'btn_Remove_' + IdDetalleSaldoInicialCuentaCobranza()}" ></button>
                      </td>
                    </tr>
                    <!-- /ko -->
                  </tbody>

<div class="modal fade" data-backdrop-limit="1" tabindex="-1" role="dialog" id="modalComprobantesPorCobrar">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
        <h3 class="panel-title">Comprobantes a Cobrar</h3>
      </div>
      <div class="modal-body">
          ...
          <div class="container-fluid">
            ...
            <div class="col-md-12">
              <fieldset>
                ...
                <table id="ComprobantesPorCobrar" class="table-bordered datalist__table table">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    <!-- ko foreach : ComprobantesPorCobrar -->
                    <tr>
                      ...
                      <td>
                        <div class="form-group">
                          ...
                          event: { focus: $parent.OnFocus, keydown: $parent.OnKeyEnter, change: (data, event) => { return OnChangeMontoCobranza(data, event, $parent.ComprobantesPorCobrar)}, focusout : ValidarMontoDolares }" data-validation="number_desc" data-validation-allowing="float,positive,range[0;9999999]" data-validation-decimal-separator="." data-validation-error-msg="De 0 a más">
                        </div>
                      </td>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="col-md-12">
              <div class="form-group">
                <button type="button" class="btn btn-primary " data-bind="event: { click: OnClickBtnCargarComprobantesCobrados}"> Cobrar Comprobantes </button>
              </div>
            </div>
          </div>
        </div>

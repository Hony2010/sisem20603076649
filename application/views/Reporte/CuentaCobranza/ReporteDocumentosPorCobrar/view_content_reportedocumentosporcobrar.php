<!-- ko with : ReporteDocumentosPorCobrar -->
      ...
      <div class="col-md-8 col-xs-12">
        ...
        <div class="panel panel-info">
          <div class="panel-heading">
            <h3 class="panel-title">Reporte Documentos por Cobrar</h3>
          </div>
          <div class="panel-body">
            <div class="datalist__result">
              <!-- ko with : Filtro -->
              <form class="form products-new" enctype="multipart/form-data" id="FormReporteDocumentosPorCobrar" name="form" action="" method="post">
                                ...
                                <div class="col-md-8">
                                  <div class="form-group">
                                    <label class="input-group">
                                      ...
                                      <input id="RazonSocialCliente_3" type="text" class="form-control formulario" placeholder="escribir para buscar...." data-bind="

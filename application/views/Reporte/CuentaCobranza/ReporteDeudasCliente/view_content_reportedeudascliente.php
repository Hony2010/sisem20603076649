      ...
      <div class="col-md-8 col-xs-12">
        ...
        <div class="panel panel-info">
          <div class="panel-heading">
            <h3 class="panel-title">Reporte Deudas por Cliente</h3>
          </div>
          <div class="panel-body">
            <div class="datalist__result">
              <!-- ko with : Filtro -->
              <form class="form products-new" enctype="multipart/form-data" id="FormReporteDeudasCliente" name="form" action="" method="post">
                    ...
                    <div class="col-md-12">
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <fieldset>
                          <fieldset>
                            <legend>Estado de Deuda</legend>
                            <div class="col-md-12">
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group">
                                    <select class="form-control formulario" data-bind="value: EstadoDeuda">
                                ...
                                <div class="col-md-8">
                                  <div class="form-group">
                                    <label class="input-group">
                                      ...
                                      <input id="RazonSocialCliente_2" type="text" class="form-control formulario" placeholder="escribir para buscar...." data-bind="
                                ...
                                <div class="input-group">
                                  <div class="multiselect-native-select formulario">
                                    ...
                                    <ul class="multiselect-container dropdown-menu" style="width: 100%;">
                                      <li>
                                        <div class="checkbox">
                                          <input id="SelectorUsuarios" type="checkbox" data-bind="event: { change: SeleccionarTodosUsuarios }" />
                                          <label for="SelectorUsuarios" class="checkbox"> Seleccionar Todos</label>
                                        </div>
                                      </li>
                                      <!-- ko foreach: Usuarios -->
                                      <li>
                                        <div class="checkbox">
                                          <input type="checkbox" data-bind="attr : { id: IdUsuario() +'_Usuario' }, event: {change: $parent.SeleccionarUsuario}" />

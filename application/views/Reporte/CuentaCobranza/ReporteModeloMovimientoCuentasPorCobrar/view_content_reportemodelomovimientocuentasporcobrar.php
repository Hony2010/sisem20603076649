<!-- ko with : ReporteModeloMovimientoCuentasPorCobrar -->
			...
			<div class="col-md-8 col-xs-12">
				...
				<div class="panel panel-info">
					<div class="panel-heading">
						<h3 class="panel-title">Reporte Movim. de Cuentas por Cobrar</h3>
					</div>
					<div class="panel-body">
						<div class="datalist__result">
							<!-- ko with : Filtro -->
							<form class="form products-new" enctype="multipart/form-data"
								id="FormReporteModeloMovimientoCuentasPorCobrar" name="form" action="" method="post">
																...
																<div class="col-md-8">
																	<div class="form-group">
																		<label class="input-group">
																			...
																			<input id="RazonSocialCliente_4" type="text" class="form-control formulario"
																...
																<div class="input-group">
																	<div class="multiselect-native-select formulario">
																		...
																		<ul class="multiselect-container dropdown-menu" style="width: 100%;">
																			<li>
																				<div class="checkbox">
																					<input id="SelectorVendedores_mcpc" type="checkbox"
																						data-bind="event: { change: SeleccionarTodosVendedores }" />
																					<label for="SelectorVendedores_mcpc" class="checkbox"> Seleccionar Todos</label>
																				</div>
																			</li>
																			...
																			<li>
																				<div class="checkbox">
																					<input type="checkbox"
																						data-bind="attr : { id: IdUsuario() +'_Vendedor_mcpc' }, event: {change: $parent.SeleccionarVendedor}" />
																					<label class="checkbox"
																						data-bind="text: AliasUsuarioVenta() + ' - ' + RazonSocial(), attr:{ for : IdUsuario() +'_Vendedor_mcpc'}"></label>
																				</div>
																			</li>
																			<!-- /ko -->
																		</ul>

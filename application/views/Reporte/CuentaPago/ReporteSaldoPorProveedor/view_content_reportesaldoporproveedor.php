<!-- ko with : ReporteSaldoPorProveedor -->
      ...
      <div class="col-md-8 col-xs-12">
        ...
        <div class="panel panel-info">
          <div class="panel-heading">
            <h3 class="panel-title">Reporte Saldos por Proveedor</h3>
          </div>
          <div class="panel-body">
            <div class="datalist__result">
              <!-- ko with : Filtro -->
              <form class="form products-new" enctype="multipart/form-data" id="FormReporteSaldoPorProveedor" name="form" action="" method="post">
                                ...
                                <div class="col-md-8">
                                  <div class="form-group">
                                    <label class="input-group">
                                      ...
                                      <input id="RazonSocialProveedor_5" type="text" class="form-control formulario" placeholder="escribir para buscar...." data-bind="

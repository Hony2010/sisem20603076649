<!-- ko with : vmgReporteVentaGeneral.dataReporteVentaGeneral -->
			...
			<div class="col-md-8 col-xs-12">
				...
				<div class="panel panel-info">
					<div class="panel-heading">
						<h3 class="panel-title">Reporte de Ventas General</h3>
					</div>
					<div class="panel-body">
						<div class="datalist__result">
							<!-- ko with : Buscador -->
							<form class="form products-new" enctype="multipart/form-data" id="form_R" name="form"
								action="" method="post">
												...
												<div class="col-md-12">
																		...
																		<label class="input-group">
																			<div class="input-group-addon addonrd">
																				<input class="radiobtn" type="radio"
																					name="NumeroDocumentoIdentidad_R"
																					value="0"
																...
																<div class="col-md-8">
																	<div class="form-group">
																		<label class="input-group">
																			...
																			<div id="DivBuscar_R"
																				class="form-group radiotxt">Buscar</div>
																			<input id="TextoBuscarOculto_R"
																				type="hidden" name="TextoCliente_D"
																				data-bind="value: IdPersona">
																			<input id="TextoBuscar_R"
																				class="form-control formulario " name=""
																				type="hidden"
													...
													<fieldset>
																...
																<div class="input-group">
																	<div class="multiselect-native-select formulario">
																		<button type="button"
																			...
																			<span
																				class="multiselect-selected-text">DOCUMENTOS
																			</span>
																			<span class="badge"
																				data-bind="text: NumeroDocumentosSeleccionados"></span>
																		...
																		<ul class="multiselect-container dropdown-menu">
																			<li>
																				<div class="checkbox">
																					<input id="SelectorTipoDocumentos_R"
																						type="checkbox"
																						data-bind="event: { change: SeleccionarTodosComprobantes }" />
																					<label
																						for="SelectorTipoDocumentos_R"
																			...
																			<li>
																				<div class="checkbox">
																					<input type="checkbox"
																						data-bind="attr : { id: IdTipoDocumento() +'_TipoDocumento_R' }, event: {change: $parent.SeleccionarComprobante}" />
														...
														<div class="col-md-12">
															<div class="form-group">
																<div class="input-group">
																	<div class="input-group-addon">Serie Documento</div>
													...
													<div class="col-md-12">
														<div class="row">
															<center>
																<hr>
																<!-- <br> -->
																<button id="btnexcel_R" name="excel" type="button"
																	class="btn btn-default"
																	data-bind="event:{click:OnClickBtnReportes}">
																	E<b><u>x</u></b>cel </button> &nbsp;
																<button id="btnpdf_R" name="pdf" type="button"
																	class="btn btn-default"
																	data-bind="event:{click:OnClickBtnReportes}"> PDF
																</button> &nbsp;
																<button id="btnpantalla_R" name="pantalla" type="button"
																	class="btn btn-default"
																	data-bind="event:{click:OnClickBtnReportes}">
																	Pantalla </button> &nbsp;
															</center>

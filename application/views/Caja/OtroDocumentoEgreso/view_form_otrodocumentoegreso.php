<!-- ko with : OtroDocumentoEgreso -->
<form  id="formOtroDocumentoEgreso" name="formOtroDocumentoEgreso" role="form" autocomplete="off">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <select id="ComboTipoOperacion" class="form-control formulario" data-bind="
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input id="ValorTipoCambio" type="text" class="form-control formulario fecha" data-bind="value: ValorTipoCambio"
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <select id="ComboMedioPago" class="form-control formulario" data-bind="
                        value : IdMedioPago,
                        options : MediosPago,

<form id="formPagoProveedor" name="formPagoProveedor" role="form" autocomplete="off">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control formulario" data-bind="value: NumeroChequeMedioPago, event : { focus : OnFocus, keydown : OnKeyEnter }" data-validation="formapagocheque" data-validation-error-msg="Debe ingresar un nro.">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
          ...
          <div class="col-md-12">
            ...
            <fieldset>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <div class="input-group">
                    <div class="input-group-addon formulario-venta">Proveedor</div>
                    <input id="RazonSocialProveedor" type="text" class="form-control formulario" data-bind="value: $parent.RazonSocialProveedor(), event: { focus: $parent.OnFocus, keydown: $parent.OnKeyEnter, blur: $parent.ValidarProveedor }" data-validation="autocompletado_proveedor" data-validation-error-msg="No se han encontrado resultados para tu búsqueda de proveedor" data-validation-text-found="">
                  </div>
                </div>
              </div>
              <div class="col-md-4">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <button id="BtnBuscarPago" type="button" class="btn btn-primary btn-control" data-bind="event: { click: $parent.OnClickBtnBucarPagoPorProveedor }"> Buscar </button>
                </div>
              </div>
            </fieldset>
            <!-- /ko -->
          ...
          <div class="col-md-12">
            <fieldset>
              ...
              <table class="table-bordered datalist__table table ">
                ...
                <tbody>
                  <!-- ko foreach : DetallesPagoProveedor -->
                  <tr>
                    ...
                    <td>
                      <div class="form-group">
                        ...
                        event: { focus: $parent.OnFocus, keydown: $parent.OnKeyEnter, change: (data, event) => { return OnChangeMontoPago(data, event, $parent.DetallesPagoProveedor)}, focusout : ValidarMontoSoles }" data-validation="number_desc" data-validation-allowing="float,positive,range[0;9999999]" data-validation-decimal-separator="." data-validation-error-msg="De 0 a más">
                      </div>
                    </td>
                    <td>
                      <div class="form-group">
                        ...
                        event: { focus: $parent.OnFocus, keydown: $parent.OnKeyEnter,  change: (data, event) => { return OnChangeMontoPago(data, event, $parent.DetallesPagoProveedor)}, focusout : ValidarMontoDolares }" data-validation="number_desc" data-validation-allowing="float,positive,range[0;9999999]" data-validation-decimal-separator="." data-validation-error-msg="De 0 a más">
                      </div>
                    </td>
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <input type="text" name="TotalSoles" class="form-control formulario text-right" data-bind="
              value: TotalSoles,
              enable: false,
              event: { focus: OnFocus, keydown: OnKeyEnter }">
            </div>
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <input type="text" name="TotalDolares" class="form-control formulario text-right" data-bind="
              value: TotalDolares,
              enable: false,
              event: {focus: OnFocus, keydown: OnKeyEnter }">
            </div>

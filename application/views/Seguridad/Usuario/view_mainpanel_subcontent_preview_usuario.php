...
<div class="products-preview datalist-preview">
  ...
  <div class="products-preview__cont">
    ...
    <div class="products-preview__name" title="Usuario" data-bind="text: RazonSocial">Nombre</div>
    ...
    <div class="products-preview__props"> <!-- Vista Previa de Familia -->
      <div class="products-preview__note "> <span><b> </b> </span><b><span class="products-preview__salary">Rol: </span></b><span class="products-preview__date" data-bind="text: NombreRol()"></span></div>
      <div class="products-preview__note "> <span><b> </b> </span><b><span class="products-preview__salary">DNI: </span></b><span class="products-preview__date" data-bind="text: NumeroDocumentoIdentidad()"></span></div>

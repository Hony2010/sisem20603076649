...
<script src="<?php echo base_url()?>assets/js/ViewModel/Configuracion/Venta/TipoTarjeta.js"></script>
...
/*
$(".class_NombreTarjeta").keyup(function()
{
  console.log("-class-");
  existecambio = true;
      ...
      //switch (event.keyCode) {
        if (event.altKey)
        {
          ...
          if(code == 78 || code == 110) // ALT + N = Nuevo Linea
          {
            ...
            //alert(code);
            Models.AgregarTipoTarjeta(null,event);
          }
...
var _primera_linea = Models.data.TiposTarjeta()[0];

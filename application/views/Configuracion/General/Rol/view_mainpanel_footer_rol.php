...
<script src="<?php echo base_url()?>assets/js/ViewModel/Configuracion/General/Rol.js"></script>
...
/*
$(".class_NombreRol").keyup(function()
{
  console.log("-class-");
  existecambio = true;
...
var _primera_linea = Models.data.Roles()[0];

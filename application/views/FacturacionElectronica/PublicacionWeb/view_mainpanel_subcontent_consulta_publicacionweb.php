    ...
    <?php echo $view_subcontent_buscador_publicacionweb; ?>
    <!-- /ko -->
    <br>
    <fieldset style="max-height: 500px; overflow: auto;">
      <table class="datalist__table table" width="100%" data-products="brand">
        ...
        <tbody>
          <!-- ko foreach : PublicacionesWeb -->
          <tr class="clickable-row" data-bind="attr : { id: IdComprobanteElectronico }" style="text-transform: UpperCase;">
    ...
    <br />
    <button id="EnviarFTP" class="btn btn-primary" data-bind="event:{click: $root.EnviarFTP}">Subir</button>

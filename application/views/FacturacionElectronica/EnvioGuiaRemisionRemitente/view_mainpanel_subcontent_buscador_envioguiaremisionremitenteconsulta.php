<div class="col-sm-12">
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
        <h6>Buscar por RUC/Transportista</h6>
        <input id="input-text-filtro2consulta" class="form-control formulario" type="text" placeholder="RUC / Transportista" data-bind="value: RazonSocial">
      </div>
    </div>
    <div class="col-md-2">
      <div class="form-group">
    ...
    <div class="col-md-2">
      <div class="form-group">
        <h6>&nbsp;</h6>
        <button id="BuscadorEnvioConsulta" class="btn btn-primary btn-control" data-bind="event: {click: BuscarGuiaRemision, change: BusquedaTexto}">Buscar</button>
      </div>
    </div>
  </div>
</div>

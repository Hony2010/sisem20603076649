...
<script src="<?php echo base_url()?>assets/js/ViewModel/Inventario/ConsultaNotaSalida/ModeloConsultaNotaSalida.js"></script>
<script src="<?php echo base_url()?>assets/js/ViewModel/Inventario/ConsultaNotaSalida/VistaModeloConsultaNotaSalida.js"></script>
<script src="<?php echo base_url()?>assets/js/template/comprobantesventa.js"></script>

<script>
    var ViewModels = new VistaModeloConsultaNotaSalida(data);

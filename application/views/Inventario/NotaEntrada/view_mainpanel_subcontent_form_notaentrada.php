<!-- ko with : NotaEntrada -->
<form  id="formNotaEntrada" name="formNotaEntrada" role="form" autocomplete="off">
  ...
  <input id="IdNotaEntrada" class="form-control" type="hidden" placeholder="IdNotaEntrada">
      ...
      <div class="scrollable scrollbar-macosx">
        <div class="container-fluid">
          <div class="row">
            <fieldset>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        event : { focus : OnFocus , change : OnChangeSerieNotaEntrada , keydown : OnKeyEnter}"
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input id="NumeroNotaEntrada" class="form-control formulario no-tab" type="text" tabindex="-1" data-bind="value: NumeroNotaEntrada ,
                      attr : { readonly : CheckNumeroNotaEntrada }, event : {  focus : OnFocus , focusout : ValidarNumeroNotaEntrada , keydown : OnKeyEnter }"
                      ...
                      data-validation-depends-on="CheckNumeroNotaEntrada" data-validation-optional="true">
                    </div>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <div class="input-group">
                      <div class="checkbox">
                        <input name="CheckNumeroNotaEntrada" id="CheckNumeroNotaEntrada" type="checkbox" class="form-control formulario"
                        data-bind="event: { change : OnChangeCheckNumeroNotaEntrada , focus : OnFocus , keydown : OnKeyEnter}" />
                        <label for="CheckNumeroNotaEntrada"> ¿Editar Numero?</label>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      value : IdMotivoNotaEntrada,
                      options : MotivosNotaEntrada,
                      optionsValue : 'IdMotivoNotaEntrada' ,
                      optionsText : 'NombreMotivoNotaEntrada',
                      event:{change: CambiarMotivoNotaEntrada, keydown : OnKeyEnter}">
                    </select>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  <div class="input-group">
                    <div class="input-group-addon formulario">Fecha Entrada</div>
                  ...
                  <div class="col-md-6">
                    <fieldset>
                      ...
                      <div class="form-group busqueda_proveedor">
                        <div class="input-group">
                          <div class="input-group-addon formulario">RUC - Proveedor</div>
          ...
          <div class="row">
            <fieldset>
                <div class="col-md-12">
                  <table id="TableDetalleNotaEntrada" class="grid-detail-body datalist__table table display" width="100%" id="tablaDetalleNotaEntrada">
                    <thead>
                      <tr>
                        ...
                        <th class="NotaEntrada_Todos DetalleNotaEntrada_ValorUnitario col-sm-1 products__title"><center>Valor Referencial</center></th>
                      </tr>
                    </thead>
                    <tbody>
                      <!-- ko foreach : DetallesNotaEntrada -->
                      <tr class="clickable-row" style="min-height: 80px;" data-bind="attr : { id: IdDetalleNotaEntrada }, event :  {focus : $parent.Seleccionar}">
                        <td class="col-sm-1">
                          <div class="form-group">
                            <input class="NotaEntrada_Todos DetalleNotaEntrada_Codigo form-control formulario"
                            data-bind="value: CodigoMercaderia, valueUpdate : 'keyup',
                            attr : { id : IdDetalleNotaEntrada() + '_input_CodigoMercaderia'},
                            event : {focus : function(data,event) { return OnFocus(data,event,$parent.OnFocus,$parent.CrearDetalleNotaEntrada); } , keydown : function(data,event) { return OnKeyEnterCodigoMercaderia(data,event,$parent.OnKeyEnter); } , focusout : ValidarCodigoMercaderia }" type="text"
                        ...
                        <td class="col-sm-9">
                          <div class="form-group">
                            <input class="NotaEntrada_Todos DetalleNotaEntrada_Descripcion form-control formulario"
                            data-bind="value: NombreProducto,
                            attr : { id : IdDetalleNotaEntrada() + '_input_NombreProducto',
                            'data-validation-reference' : IdDetalleNotaEntrada() + '_input_CodigoMercaderia'  },
                            event: { focus : function(data,event) { return OnFocus(data,event,$parent.OnFocus,$parent.CrearDetalleNotaEntrada); }  }" type="text"
                        ...
                        <td class="col-sm-1  text-center">
                          <span class="" data-bind="text : AbreviaturaUnidadMedida, attr : { id : IdDetalleNotaEntrada() + '_span_AbreviaturaUnidadMedida'}"></span>
                        </td>
                        <td class="col-sm-1">
                          <div class="form-group">
                            <input name="Cantidad" class="NotaEntrada_Todos DetalleNotaEntrada_Cantidad form-control formulario numeric text-mumeric"
                            data-bind="value : Cantidad , attr : { id : IdDetalleNotaEntrada() + '_input_Cantidad','data-cantidad-decimal' : DecimalCantidad() },
                            event: {focus : function(data,event) { return OnFocus(data,event,$parent.OnFocus,$parent.CrearDetalleNotaEntrada); } , keydown : function(data,event) { return OnKeyEnter(data,event,$parent.OnKeyEnter); } , focusout : ValidarCantidad } , numberdecimal : Cantidad" type="text"
                        ...
                        <td class="NotaEntrada_Todos DetalleNotaEntrada_ValorUnitario col-sm-1">
                          <input name="ValorUnitario" class="NotaEntrada_Todos DetalleNotaEntrada_ValorUnitario form-control  formulario numeric text-mumeric inputs"
                          data-bind="value : ValorUnitario ,
                          attr : { id : IdDetalleNotaEntrada() + '_input_ValorUnitario','data-cantidad-decimal' : DecimalValorUnitario() },
                          event: { focus: function(data,event) { return OnFocus(data,event,$parent.OnFocus,$parent.CrearDetalleNotaEntrada); } , keydown : function(data,event) { return OnKeyEnter(data,event,$parent.OnKeyEnter); } , focusout : ValidarValorUnitario} , numberdecimal : ValorUnitario" type="text"
                      ...
                      <td class="col-sm-auto">
                        <div class="form-group ajuste-opcion-plusminus">
                          ...
                          data-bind="click : $parent.QuitarDetalleNotaEntrada, visible: EstadoInputOpcion(),
                          event : { focus: function(data,event) { return OnFocus(data,event,$parent.OnFocus,$parent.CrearDetalleNotaEntrada); } ,keydown : function(data,event) { return OnKeyEnterOpcion(data,event,$parent.OnKeyEnter); }  },
                          attr : { id : IdDetalleNotaEntrada() + '_a_opcion'}" ></button>
                        </div>
                      </td>
                    </tr>
                    <!-- /ko -->

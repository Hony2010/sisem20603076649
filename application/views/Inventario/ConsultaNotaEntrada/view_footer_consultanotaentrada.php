...
<script src="<?php echo base_url()?>assets/js/ViewModel/Inventario/ConsultaNotaEntrada/ModeloConsultaNotaEntrada.js"></script>
<script src="<?php echo base_url()?>assets/js/ViewModel/Inventario/ConsultaNotaEntrada/VistaModeloConsultaNotaEntrada.js"></script>
<script src="<?php echo base_url()?>assets/js/template/comprobantesventa.js"></script>

<script>
    var ViewModels = new VistaModeloConsultaNotaEntrada(data);

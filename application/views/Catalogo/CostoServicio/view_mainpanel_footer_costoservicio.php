...
<script src="<?php echo base_url()?>assets/js/ViewModel/Catalogo/CostoServicio.js"></script>
...
/*
$(".class_NombreCostoServicio").keyup(function()
{
  console.log("-class-");
  existecambio = true;
      ...
      //switch (event.keyCode) {
        if (event.altKey)
        {
          ...
          if(code == 78 || code == 110) // ALT + N = Nuevo Linea
          {
            ...
            //alert(code);
            Models.AgregarCostoServicio(null,event);
          }
...
var _primera_linea = Models.data.CostosServicio()[0];

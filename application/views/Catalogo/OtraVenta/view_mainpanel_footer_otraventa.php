...
<script src="<?php echo base_url()?>assets/js/ViewModel/Catalogo/OtraVenta.js"></script>
      ...
      //switch (event.keyCode) {
        if (event.altKey)
        {
          ...
          if(code == 78 || code == 110) // ALT + N = Nuevo Linea
          {
            ...
            //alert(code);
            Models.AgregarOtraVenta(null,event);
          }
...
if(Models.data.OtrasVenta().length > 0)
{
  var _primera_linea = Models.data.OtrasVenta()[0];

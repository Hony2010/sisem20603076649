<!-- ko with : Proveedor  -->
<form class="form products-new" enctype="multipart/form-data" id="formproveedor" name="formproveedor" role="form" autocomplete="off">
  <!-- action="" method="post" -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="checkbox checkbox-inline">
          <input id="IndicadorEstadoProveedor" type="checkbox" class="no-tab" data-bind="checked : IndicadorEstadoProveedor">
          <label for="IndicadorEstadoProveedor">Estado Proveedor</label>
        </div>
      </div>
    </div>
    <div class="row">

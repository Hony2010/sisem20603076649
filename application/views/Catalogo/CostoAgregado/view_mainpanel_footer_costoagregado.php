...
<script src="<?php echo base_url()?>assets/js/ViewModel/Catalogo/CostoAgregado.js"></script>
...
/*
$(".class_NombreCostoAgregado").keyup(function()
{
  console.log("-class-");
  existecambio = true;
      ...
      //switch (event.keyCode) {
        if (event.altKey)
        {
          ...
          if(code == 78 || code == 110) // ALT + N = Nuevo Linea
          {
            ...
            //alert(code);
            Models.AgregarCostoAgregado(null,event);
          }
...
if(Models.data.CostosAgregado().length > 0)
{
  var _primera_linea = Models.data.CostosAgregado()[0];

<div class="scrollable scrollbar-macosx">
  <?php echo $view_subcontent_buscador_transportistas; ?>
  <fieldset>
    <table id="TablaConsultaTransportistas" class="datalist__table table display table-border" width="100%" data-products="brand">
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr class="clickable-row text-uppercase" data-bind="click : $root.Seleccionar, attr : { id: IdPersona }">
          ...
          <td align="center" >
            ...
            class="btn btn-sm btn-warning btn-operaciones" data-toogle="tooltip" title="Editar Transportista">
              <span class="glyphicon glyphicon-pencil"></span>
            </button>
          </td>
          <td align="center">
            <button data-bind="click : $root.OnClickBtnEliminar"
            class="btn btn-sm btn-danger btn-operaciones" data-toogle="tooltip" title="Eliminar Transportista">
      ...
      <?php echo $view_subcontent_paginacion_transportistas; ?>
</div>

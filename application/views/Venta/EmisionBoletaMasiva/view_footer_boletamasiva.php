...
<script src="<?php echo base_url()?>assets/js/ViewModel/Venta/BoletaMasiva/MappingMasivo.js"></script>
<script src="<?php echo base_url()?>assets/js/ViewModel/Venta/BoletaMasiva/ModeloBoletaMasiva.js"></script>
<!-- <script src="<?php echo base_url()?>assets/js/ViewModel/Venta/BoletaMasiva/ModeloDetalleBoletaMasiva.js"></script> -->
<script src="<?php echo base_url()?>assets/js/ViewModel/Venta/BoletaMasiva/VistaModeloBoletaMasiva.js"></script>
<script src="<?php echo base_url()?>assets/js/ViewModel/Venta/BoletaMasiva/VistaModeloDetalleBoletaMasiva.js"></script>
<!-- <script src="<?php echo base_url()?>assets/js/ViewModel/Venta/BoletaMasiva/VistaModeloBoletaMasiva.js"></script> -->
<script src="<?php echo base_url()?>assets/js/ViewModel/Venta/EmisionBoletaMasiva/VistaModeloEmisionBoletaMasiva.js"></script>
...
<script>
  ...
  var ViewModels = new VistaModeloEmisionBoletaMasiva(data);
  ko.cleanNode(koNode);
...
<script type="text/javascript">
  ...
  $("body").on("click","#Descargar_Plantilla",function functionName() {
    window.location = data.data.BoletaMasiva.RutaPlantillaExcel;
  });
</script>

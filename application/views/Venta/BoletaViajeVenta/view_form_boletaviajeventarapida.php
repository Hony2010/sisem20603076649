                    ...
                    <table class="datalist__table table display grid-detail-body table-border" width="100%" id="tablaDetalleComprobanteVenta">
                      ...
                      <tbody>
                        ...
                        <tr name="Fila" class="clickable-row" style="min-height: 80px;" data-bind="attr : { id: IdDetalleComprobanteVenta()+'_tr_detalle' }, click :  function(data,event) { return OnClickFila(data,event,$parent.OnRefrescar); } ">
                          ...
                          <td class="col-sm-1">
                            <input name="NumeroDocumentoSalidaZofra" class="form-control formulario"
                            data-bind="value : NumeroDocumentoSalidaZofra , attr : { id : IdDetalleComprobanteVenta() + '_input_NumeroDocumentoSalidaZofra'},
                            event: {focus : function(data,event) { return OnFocus(data,event,$parent.OnRefrescar); } , keydown : function(data,event) { return OnKeyEnter(data,event,$parent.OnKeyEnter); }, focusout : ValidarNumeroDocumentoSalidaZofra } , ko_autocomplete_zofra: { zofra: DataListaZofra($parent.IdAsignacionSede()),id: IdDocumentoSalidaZofraProducto}" type="text"
                            data-validation="required_zofra" data-validation-error-msg="Requerido" data-validation-found="false">
                          </td>
                          <!-- /ko -->

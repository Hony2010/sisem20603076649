...
<script src="<?php echo base_url()?>assets/js/ViewModel/Venta/EmisionOrdenPedido/VistaModeloEmisionOrdenPedido.js"></script>
...
<script src="<?php echo base_url()?>assets/js/ViewModel/Venta/OrdenPedido/AutoCompletadoComprobanteVentaReferencia.js"></script>
...
<script>
  ...
  var ViewModels = new VistaModeloEmisionOrdenPedido(data);
  ko.cleanNode(koNode);

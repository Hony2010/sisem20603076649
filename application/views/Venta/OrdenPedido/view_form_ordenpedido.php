<!-- ko with : OrdenPedido -->
<form id="formOrdenPedido" name="formOrdenPedido" role="form" autocomplete="off">
                        ...
                        event : { change : OnChangeFormaPago , focus : OnFocus , keydown : OnKeyEnter }">
                          ...
                          event : { focus : OnFocus, keydown : OnKeyEnter, change : OnChangeDireccion }">
									...
									<div class="col-md-6">
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-addon formulario-venta">Doc. Referencia</div>
												<input id="DocumentoVentaReferencia" class="form-control formulario"
													type="text" data-bind="
													value: DocumentoVentaReferencia,
													attr: { 'data-validation': ParametroRubroClinica() == '1' ? 'autocompletado_opcional' : 'autocompletado' },
													event: { focus : OnFocus, change: ValidarComprobanteVentaReferencia }" data-validation-error-msg=""
													data-validation-text-found="">
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											<div class="input-group">
												...
												<div class="input-group-btn">
													<button type="button" class="btn-buscar btn btn-default no-tab"
														data-bind="click : (data,event) => OnClickBtnBuscarProformas(data, event, $parent.OrdenPedido)">
									...
									<!-- /ko -->
									<!-- /ko -->
									<!-- ko if:(ParametroSauna() == 1 ) -->
									<div class="col-md-6">
										<div class="form-group">
											<button type="button" class="btn btn-default btn-control"
												data-bind="event: { click: OnClickBtnCasillerosPorGenero }">
												<b>Genero: </b>
												<span data-bind="text: NombreGenero"></span>
												<b>Casillero: </b>
												<span data-bind="text: NombreCasillero"></span>
											</button>
										</div>
									</div>
									<!-- /ko -->
										...
										<fieldset style="padding: 2px !important;">
											<legend>
												<div class="radio radio-inline">
													<input id="radOrd1" type="radio" name="radio" class="" value="0"
														data-bind="checked : EstadoPendienteNota,event : { change : OnChangeEstadoPendienteNota, keydown : OnKeyEnter }">
													<label for="radOrd1">Afecta Kardex</label>
												</div>
												<div class="radio radio-inline">
													<input id="radOrd2" type="radio" name="radio" class="" value="1"
														data-bind="checked : EstadoPendienteNota,event : { change : OnChangeEstadoPendienteNota, keydown : OnKeyEnter }">
													<label for="radOrd2">Pendiente entrega con Nota de Salida</label>
												</div>
											</legend>
											<div class="col-md-6">
												<div class="form-group">
													<div class="input-group">
														...
														<select id="combo-almacen" class="form-control formulario"
															...
															event : { focus : OnFocus ,
															change : (data,event) => OnChangeComboAlmacen(data,event,$parent) ,                            
															keydown : OnKeyEnter }" data-validation="required"
										...
										<table class="datalist__table table display grid-detail-body table-border"
											...
											<thead>
												<tr>
													...
													<!-- /ko -->
													<!-- ko if: (ParametroCantidadCaja() != 0) -->
													<th class="col-sm-1 products__title">
														<center>Cantidad Caja</center>
													</th>
													<!-- /ko -->
											...
											<tbody>
												...
												<tr name="Fila" class="clickable-row" style="min-height: 80px;"
													...
													<!-- /ko -->
													<!-- ko if: ($parent.ParametroCantidadCaja() != 0) -->
													<td class="col-sm-1">
														<input name="CantidadCaja"
															class="form-control formulario numeric text-mumeric inputs"
															data-bind="value : CantidadCaja ,
															disable: ProductoBonificado,
															attr : { id : IdDetalleComprobanteVenta() + '_input_CantidadCaja'},
															event: { focus: function(data,event) { return OnFocus(data,event,$parent.OnRefrescar); } , keydown : function(data,event) { return OnKeyEnter(data,event,$parent.OnKeyEnter); }}"
															type="text">
													</td>
													<!-- /ko -->
...
<!-- 						<div class="col-md-2">
						...
						<div class="col-md-2">
							<div class="form-group">
								<div class="addon-top">Envío y Gestión</div>
								<input class="form-control formulario numeric text-mumeric input-totales" type="text"
									placeholder="0.00"
									data-bind="value : MontoEnvioGestion, numbertrim : MontoEnvioGestion, event:{focus: OnFocus, keydown : OnKeyEnter, focusout : CalcularTotales}">
							</div>
						</div>
						<!-- /ko -->
						<div class="col-md-2">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input id="ACuenta" class="form-control formulario numeric text-mumeric input-totales"
									type="text" placeholder="0.00"
									data-bind="value : MontoACuenta, numbertrim :MontoACuenta, event:{ focus: OnFocus, keydown : OnKeyEnter, change: OnChangeMontoACuenta}">
							</div>
						</div>
						<!-- /ko -->
						<!-- ko if:(ParametroRubroClinica() == 1) -->
...
<!-- 						<div class="col-md-2">
							<div class="form-group">
								...
								<input id="MontoDebe" class="form-control formulario numeric text-mumeric input-totales"
									type="text" placeholder="0.00" readonly data-bind="
                value: MontoDebe, 
                numbertrim: MontoDebe, 
                event:{ focus: OnFocus, keydown : OnKeyEnter}" data-validation="number_desc"
									data-validation-allowing="float,range[0.001;9999999]"
									data-validation-decimal-separator="." data-validation-error-msg="Mayor o igual a 0">
							</div>
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input id="MontoComision"
									...
									placeholder="0.00" data-bind="
                value: MontoRecibido, 
                numbertrim: MontoRecibido, 
                event:{ focus: OnFocus, keydown : OnKeyEnter, change: OnChangeMontoRecibido}"
									data-validation="number_desc" data-validation-allowing="float,range[0.001;9999999]"
									data-validation-decimal-separator="." data-validation-error-msg="Mayor o igual a 0">
							</div>
						</div>
						<div class="col-md-2">

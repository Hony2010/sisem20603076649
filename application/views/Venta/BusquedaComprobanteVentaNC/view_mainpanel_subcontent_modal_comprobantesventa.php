<div class="modal fade" data-backdrop-limit="1" tabindex="-1" role="dialog"  id="BusquedaComprobantesVentaModelNC" data-backdrop="static">
              ...
              <div  style="max-height: 300px;overflow: auto">
                <fieldset>
                  <table id="DataTables_Table_0_otraunidadmedida" class="datalist__table table display" width="100%" data-products="brand" >
                    ...
                    <tbody>
                      <!-- ko foreach : BusquedaComprobantesVentaNC -->

    ...
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
          <input id="input-text-filtro-mercaderia" class="form-control formulario" type="text" placeholder="Buscar por Nro de Documento" data-bind="value : textofiltro">
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
          <div class="input-group">
            ...
            <!-- <input id="fecha-inicio" class="form-control formulario" type="date" data-bind="value: FechaInicio"> -->
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
          <div class="input-group">
            ...
            <!-- <input id="fecha-fin" class="form-control formulario" type="date" data-bind="value: FechaFin"> -->
          </div>
        </div>
      </div>
      <div class="col-md-2">

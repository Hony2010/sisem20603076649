...
<script src="<?php echo base_url()?>assets/js/ViewModel/Venta/EmisionProforma/VistaModeloEmisionProforma.js"></script>
...
<script>
  ...
  var ViewModels = new VistaModeloEmisionProforma(data);
  ko.cleanNode(koNode);

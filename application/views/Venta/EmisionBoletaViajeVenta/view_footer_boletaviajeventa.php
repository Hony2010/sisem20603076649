...
<script src="<?php echo base_url()?>assets/js/ViewModel/Venta/EmisionBoletaViajeVenta/VistaModeloEmisionBoletaViajeVenta.js"></script>
...
<script>
  ...
  var ViewModels = new VistaModeloEmisionBoletaViajeVenta(data);
  ko.cleanNode(koNode);

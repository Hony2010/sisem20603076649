<div class="modal fade" data-backdrop-limit="1" tabindex="-1" role="dialog"  id="modalNotaCreditoDevolucion"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                  <div class="col-md-3">
                      <h3 class="panel-title" style="margin-top: 3px;">
                      Edición Nota de Devolución</h3>
                  </div>
                  ...
                  <div class="col-md-8" style="float:right;">
                    <?php echo $view_panel_header_notadevolucionventa; ?>
                  </div>
            </div>
            <div class="modal-body">
                <?php echo $view_form_notadevolucionventa; ?>
            </div>
        </div>
    </div>
</div>

<!-- ko with : NotaCredito  -->
<form  id="formNotaCreditoDevolucion" name="formNotaCreditoDevolucion" role="form" autocomplete="off">
    <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input id="FechaEmision" name="FechaEmision" class="form-control formulario" data-inputmask-clearmaskonlostfocus="false" data-bind="value: FechaEmision, event: {focusout : ValidarFechaEmision, keydown : OnKeyEnter, change: OnChangeFechaEmision}"
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <div class="input-group">
                              ...
                              <input disabled tabindex="-1" id="FechaIngreso" name="FechaIngreso" class="form-control formulario no-tab" data-inputmask-clearmaskonlostfocus="false" data-bind="value: FechaIngreso, event:{keydown : OnKeyEnter}"
                              data-validation="fecha_vencimiento" data-validation-format="dd/mm/yyyy" data-validation-error-msg=""/>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <div class="input-group">
                              ...
                              <select tabindex="-1" id="combo-tipodocumento" class="form-control formulario no-tab" data-bind="
      ...
      <table id="tablaDetalleComprobanteVenta" class="datalist__table table display no-footer" width="100%" data-products="brand">
        <thead>
          <tr>
            ...
            <th class="NotaCredito_Todos DetalleNotaCredito_Descuento col-sm-1 products__title"><center>Desc.</center></th>
            <th class="NotaCredito_Todos DetalleNotaCredito_DescuentoUnitario col-sm-1 products__title"><center>Desc. Unitario</center></th>
        ...
        <tbody>
          ...
          <tr class="clickable-row" style="min-height: 80px;" data-bind="attr : { id: IdDetalleComprobanteVenta }, click : $parent.Seleccionar , event : {focusout : $parent.Refrescar}">
            <td class="col-sm-1 op-codigo">
              <input class="NotaCredito_Todos DetalleNotaCredito_Codigo form-control input-detallecomprobanteventa formulario"
          ...
          <td class="col-sm-6">
            <input class="NotaCredito_Todos DetalleNotaCredito_Descripcion form-control input-detallecomprobanteventa formulario"
          ...
          <td class="col-sm-1">
            <input name="Cantidad" class="NotaCredito_Todos DetalleNotaCredito_Cantidad form-control input-detallecomprobanteventa formulario numeric text-mumeric"
            ...
            data-validation="number_calc" data-validation-allowing="float,positive,range[0.001;9999999]" data-validation-decimal-separator="." data-validation-error-msg="Debe ser de 0 a más">
          </td>
          <td class="col-sm-1">
            <input name="PrecioUnitario" class="NotaCredito_Todos DetalleNotaCredito_PrecioUnitario form-control input-detallecomprobanteventa formulario numeric text-mumeric"
            ...
            data-validation="number_calc" data-validation-allowing="float,positive,range[0.001;9999999]" data-validation-decimal-separator="." data-validation-error-msg="Debe ser positivo">
          </td>
          <td class="NotaCredito_Todos DetalleNotaCredito_Descuento col-sm-1">
            <input name="DescuentoItem" class="NotaCredito_Todos DetalleNotaCredito_Descuento form-control input-detallecomprobanteventa formulario numeric text-mumeric"
          ...
          <td class="NotaCredito_Todos DetalleNotaCredito_DescuentoUnitario col-sm-1">
            <input class="NotaCredito_Todos DetalleNotaCredito_DescuentoUnitario form-control input-detallecomprobanteventa formulario numeric text-mumeric"
            data-bind="value : DescuentoUnitario,
          ...
          <td class="col-sm-1">
            <input class="NotaCredito_Todos DetalleNotaCredito_Importe form-control input-detallecomprobanteventa formulario numeric text-mumeric"
          ...
          <td class="col-sm-auto">
            <div class="input-group ajuste-opcion-plusminus">
              <button type="button" class="NotaCredito_Todos DetalleNotaCredito_AgregarEliminar btn btn-default focus-control glyphicon glyphicon-minus no-tab" data-bind="click : $parent.QuitarDetalleComprobanteVenta, attr : { id : IdDetalleComprobanteVenta() + '_a_opcion'}" ></button>
            </div>
          </td>
        </tr>
        <!-- /ko -->
  ...
  <div class="col-md-4">
    <div class="form-group">
      <div class="input-group">
        ...
        <input id="TotalFacturas" tabindex="-1" readonly class="NotaCredito_Todos NotaCredito_TotalFacturas form-control formulario numeric text-mumeric no-tab" type="text" placeholder="TotalFacturas" data-bind="value: TotalSaldo">
      </div>
    </div>
  </div>
</div>
    ...
    <table id="tablaConceptoComprobanteVenta" class="datalist__table table display no-footer" width="100%" data-products="brand">
      <thead>
        <tr>
          ...
          <th class="NotaCredito_Todos NotaCredito_Porcentaje col-sm-2 products__title"><center>Porcentaje</center></th>
          <th class="NotaCredito_Todos NotaCredito_Importe col-sm-2 products__title"><center>Importe</center></th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr class="clickable-row" style="min-height: 80px;" data-bind="">
          <td class="NotaCredito_Todos NotaCredito_Concepto col-sm-8">
            <select id="combo-conceptonotacredito" class="NotaCredito_Todos NotaCredito_Concepto form-control formulario" data-bind="
            value : Concepto,
        ...
        <td class="NotaCredito_Todos NotaCredito_Porcentaje col-sm-2">
          <input id="input_porcentaje" name="Porcentaje" class="NotaCredito_Todos NotaCredito_Porcentaje form-control formulario numeric text-mumeric"
          ...
          data-validation="number_calc" data-validation-allowing="float,positive,range[1;9999999]" data-validation-decimal-separator="." data-validation-error-msg="Debe ser positivo, mayor a 0 y menor igual a 100">
        </td>
        <td class="NotaCredito_Todos NotaCredito_Importe col-sm-2">
          <input id="input_importe" name="Importe" class="NotaCredito_Todos NotaCredito_Importe form-control formulario numeric text-mumeric"
          ...
          data-validation="number_calc" data-validation-allowing="float,positive,range[1;9999999]" data-validation-decimal-separator="." data-validation-error-msg="Debe ser positivo, mayor a 0">
        </td>
      </tr>
...
<div id="footer_notacredito" class="row">
  ...
  <div class="col-md-2">
    <div class="form-group">
      ...
      <input id="ValorVentaGravado" class="NotaCredito_Todos NotaCredito_Gravada form-control formulario numeric text-mumeric input-totales" type="text" placeholder="Op. Grav." data-bind="value: ValorVentaGravado, event: {focus : OnFocus , focusout: CalcularTotalesByFooter, keydown : OnKeyEnter},numbertrim: ValorVentaGravado">
    </div>
  </div>
  <div class="col-md-2">
    <div class="form-group">
      <div class="addon-top">Op. Exonerado</div>
      <input id="ValorVentaNoGravado" class="NotaCredito_Todos NotaCredito_NoGravada form-control formulario numeric text-mumeric input-totales" type="text" placeholder="Op. No Grav." data-bind="value: ValorVentaNoGravado, event: {focus : OnFocus , focusout: CalcularTotalesByFooter, keydown : OnKeyEnter},numbertrim: ValorVentaNoGravado">
    </div>
  </div>
  <div class="col-md-2">
    <div class="form-group">
      <div class="addon-top">Op. Inafecto</div>
      <input id="ValorVentaInafecto" class="NotaCredito_Todos NotaCredito_Inafecto form-control formulario numeric text-mumeric no-tab input-totales" type="text" placeholder="Op. Ina." data-bind="value: ValorVentaInafecto, event: {focus : OnFocus , focusout: CalcularTotalesByFooter, keydown : OnKeyEnter},numbertrim: ValorVentaInafecto">
    </div>
  </div>
  <div class="col-md-1">
    <div class="form-group">
      <div class="addon-top">IGV</div>
      <input id="IGV" class="NotaCredito_Todos NotaCredito_IGV form-control formulario numeric text-mumeric input-totales" type="text" placeholder="IGV" data-bind="value: CalculoTotalIGV(), keydown : OnKeyEnter, numbertrim: IGV">
    </div>
  </div>
  <div class="col-md-2">
    <div class="form-group">
      <div class="addon-top">Total</div>
      <input id="Total" class="NotaCredito_Todos NotaCredito_Total form-control formulario numeric text-mumeric input-totales" type="text" placeholder="Total" data-bind="value : CalculoTotalVenta(), keydown : OnKeyEnter">
    </div>
  </div>
</div>
</div>

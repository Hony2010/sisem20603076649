...
<div class="datalist__result" id="panelheaderComprobanteVenta">
  <div class="col-md-4">
    <div class="form-group">
      <div class="input-group" >
        <div class="input-group-addon"><span class="glyphicon glyphicon-user"></div>
        <input id="Vendedor" readonly class="form-control formulario no-tab" type="text" tabindex="-1" placeholder="Vendedor" data-bind="value : AliasUsuarioVenta">
      </div>
    </div>
  </div>
  <div class="col-md-3">
    <div class="form-group">
      <div class="input-group">
        ...
        <input id="ValorTipoCambio"  readonly class="form-control formulario numeric text-mumeric" type="text" data-bind="value: ValorTipoCambio, event : {focus : OnFocus, keydown : OnKeyEnter}">
      </div>
    </div>
  </div>
  <div class="col-md-2">

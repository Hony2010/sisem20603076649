...
<form  id="formFacturaVenta" name="formFacturaVenta" role="form" autocomplete="off">
  <div class="datalist__result">
    ...
    <a  id="Nueva_Factura" class="ocultar" target="_blank" href="<?php echo site_url()?>/Venta/cEmisionFacturaVenta/"></a>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input id="NombreGradoAlumno" disabled class="form-control formulario no-tab" type="text" data-bind="value: NombreGradoAlumno, event : {  focus : OnFocus , keydown : OnKeyEnter }"
                      data-validation=""  data-validation-error-msg="Requerido">
                    </div>
                  </div>
                </div>
                <!-- /ko -->
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <select name="combo-Motivo" id="combo-Motivo" class="form-control formulario" data-bind="
                      ...
                      data-validation="required" data-validation-error-msg="No tiene motivos asignados">
                    </select>
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-md-12">
                    <div class="col-md-6">
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <input id="RazonSocialDestinatario" name="RazonSocialDestinatario" class="form-control formulario" type="text" data-bind="value : RazonSocialDestinatario(),event : { focus : OnFocus }"
                          data-validation="autocompletado_RazonSocialDestinatario" data-validation-error-msg="No se han encontrado resultados" data-validation-text-found="">
                          <div class="input-group-btn">
                    ...
                    <div class="col-md-5">
                      <div class="form-group">
                        <div class="input-group">
                          <div class="input-group-addon formulario-venta">Destinatario</div>
                          <input id="Destinatario" class="form-control formulario" type="text" data-bind="value : Destinatario, event : { focus : OnFocus, keydown : OnKeyEnter, focusout : ValidarDestinatario }"
                          data-validation="required" data-validation-error-msg="Campo requerido" data-validation-text-found="">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-1">
                      <div class="form-group">
                        <div class="input-group">
                          <div class="checkbox">
                            <input name="CheckDestinatario" id="CheckDestinatario" type="checkbox" class="form-control formulario"
                            data-bind="checked:CheckDestinatario, event: { change : OnChangeCheckDestinatario , focus : OnFocus , keydown : OnKeyEnter}" />
              ...
              <fieldset style="padding: 2px !important;">
                <legend>
                  <div class="radio radio-inline">
                    <input id="radFac1" type="radio" name="radio" class="" value="0" data-bind="checked : EstadoPendienteNota,event : { change : OnChangeEstadoPendienteNota, keydown : OnKeyEnter }">
                    <label for="radFac1">Afecta Kardex</label>
                  </div>
                  <div class="radio radio-inline">
                    <input id="radFac2" type="radio" name="radio"  class="" value="1" data-bind="checked : EstadoPendienteNota,event : { change : OnChangeEstadoPendienteNota, keydown : OnKeyEnter }">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input id="FechaMovimientoAlmacen" name="FechaMovimientoAlmacen" class="form-control formulario" data-inputmask-clearmaskonlostfocus="false"
                    data-bind="value: FechaMovimientoAlmacen, event : {focus : OnFocus , focusout : ValidarFechaMovimientoAlmacen,  keydown : OnKeyEnter}"
                    data-validation="date" data-validation-format="dd/mm/yyyy" data-validation-error-msg="La fecha de nota de salida es invalida"/>
                  </div>
                </div>
              </div>
            </fieldset>
                ...
                <div class="row detalle-comprobante">
                  <div class="col-md-12">
                    <table class="datalist__table table display grid-detail-body table-border" width="100%" id="tablaDetalleComprobanteVenta">
                      <thead>
                        <tr>
                          <th class="col-sm-2 products__id"><center>Código</center></th>
                          ...
                          <th class="products__title"><center>Marca</center></th>
                          <!-- /ko -->
                          <!-- ko if:(TipoVenta() == TIPO_VENTA.MERCADERIAS) -->
                          <th class="products__title"><center>Unid.</center></th>
                          <!-- /ko -->
                          <!-- ko if:(ParametroStockProductoVenta() != 0 && TipoVenta() == TIPO_VENTA.MERCADERIAS) -->
                          <th class="col-sm-1 products__title"><center>Stock</center></th>
                          <!-- /ko -->
                          <!-- ko if: (ParametroDua() != 0 && (TipoVenta() == TIPO_VENTA.MERCADERIAS))-->
                          <th class="col-sm-1 products__title"><center>Documento D.U.A.</center></th>
                          <!-- /ko -->
                          <!-- ko if: (ParametroLote() != 0 && (TipoVenta() == TIPO_VENTA.MERCADERIAS)) -->
                          <th class="col-sm-1 products__title"><center>Lote</center></th>
                          <!-- /ko -->
                          ...
                          <th class="col-sm-1 products__title"><center>Desc. Unit.</center></th>
                          <!-- /ko -->
                          <!-- ko if: (ParametroDescuentoItem() != 0 && TipoVenta() == TIPO_VENTA.MERCADERIAS) -->
                          <th class="products__title"><center>Desc. Item</center></th>
                          <!-- /ko -->
                        ...
                        <tr name="Fila" class="clickable-row" style="min-height: 80px;" data-bind="attr : { id: IdDetalleComprobanteVenta()+'_tr_detalle'}, click :  function(data,event) { return OnClickFila(data,event,$parent.OnRefrescar); } ">
                          <td class="col-sm-2">
                            <div class="input-group">
                              ...
                              event : {input:function(data,event) { return OnChangeText(data, event, $parent); } , focus : function(data,event) { return OnFocus(data,event,$parent.OnRefrescar); } , keydown : function(data,event) { return OnKeyEnterCodigoMercaderia(data,event,$parent.OnKeyEnter); }  }" type="text"
                          ...
                          <td class="col-sm-2">
                            <input name="Observacion" class="form-control  formulario numeric text-mumeric inputs"
                            data-bind="value : Observacion ,
                            attr : { id : IdDetalleComprobanteVenta() + '_input_Observacion'},
                            event: { focus: function(data,event) { return OnFocus(data,event,$parent.OnRefrescar); } , keydown : function(data,event) { return OnKeyEnter(data,event,$parent.OnKeyEnter); } , focusout : ValidarObservacion} ," type="text"
                            data-validation="" data-validation-error-msg="requerido">
                          </td>
                          <!-- /ko -->
                          ...
                          <td class="col-sm-1">
                            ...
                            data-bind="value : NumeroDua, attr : { id : IdDetalleComprobanteVenta() + '_input_NumeroDua'}, enable:OnEnableDua(),
                            event: {focus : function(data,event) { return OnFocus(data,event,$parent.OnRefrescar); } , keydown : function(data,event) { return OnKeyEnter(data,event,$parent.OnKeyEnter); }, focusout : ValidarNumeroDua } , ko_autocomplete_dua: { dua: DataListaDua($parent.IdAsignacionSede()),id: IdDuaProducto}" type="text"
                            data-validation="required_dua" data-validation-error-msg="Requerido" data-validation-found="false">
                          </td>
                          <!-- /ko -->
                          ...
                          <td class="col-sm-1">
                            ...
                            event: {focus : function(data,event) { return OnFocus(data,event,$parent.OnRefrescar); } , keydown : function(data,event) { return OnKeyEnter(data,event,$parent.OnKeyEnter); }, focusout : ValidarNumeroLote } , ko_autocomplete_lote: { lote: DataLotes($parent.IdAsignacionSede()),id: IdLoteProducto}" type="text"
                            data-validation="required_lote" data-validation-error-msg="Requerido" data-validation-found="false">
                          </td>
                          <!-- /ko -->
                          <!-- ko if: ($parent.TipoVenta() != TIPO_VENTA.SERVICIOS) -->
                          <td class="col-sm-1">
                            <input name="Cantidad" class="form-control formulario numeric text-mumeric"
                            data-bind="value : Cantidad , attr : { id : IdDetalleComprobanteVenta() + '_input_Cantidad', 'data-cantidad-decimal' : DecimalCantidad() },
                            event: {focus : function(data,event) { return OnFocus(data,event,$parent.OnRefrescar); } , keydown : function(data,event) { return OnKeyEnter(data,event,$parent.OnKeyEnter); } , focusout : ValidarCantidad, blur: function (data,event){return CalculoSubTotal(data,event,$parent.OnRefrescar);} } , numberdecimal : Cantidad, ko_autocomplete_cantidad: { source: DataPrecios(), raleo: DataRaleo(), precio: PrecioUnitario}" type="text"
                          ...
                          <!-- /ko -->
                          <td class="col-sm-1">
                            <input name="PrecioUnitario" list="items" class="form-control  formulario numeric text-mumeric inputs"
                          ...
                          <td class="col-sm-1">
                            <input name="DescuentoUnitario" class="form-control formulario numeric text-mumeric inputs" data-cantidad-decimal="2"
                          ...
                          <td class="col-sm-1">
                            <div class="input-group">
                              ...
                              event : { focus: function(data,event) { return CalculoSubTotal(data,event,$parent.OnRefrescar); }, keydown : function(data,event) { return OnKeyEnter(data,event,$parent.OnKeyEnter); }, focusout: ValidarSubTotal, change: function (data,event){return CalculoPrecioUnitario(data,event,$parent.OnRefrescar);} }, numbertrim:SubTotal"
                              type="text" data-validation="number_calc" data-validation-allowing="float,positive,range[0.001;9999999]" data-validation-decimal-separator="." data-validation-error-msg="De 0 a más">
                            </div>
                          </td>

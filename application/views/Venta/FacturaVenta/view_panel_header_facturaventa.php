...
<div class="datalist__result" id="panelHeaderFacturaVenta">
      ...
      <div class="form-group">
        <div class="input-group">
          ...
          <select id="combo-moneda" class="form-control formulario" data-bind="
              ...
              event : { focus : OnFocus, keydown : OnKeyEnter, change: OnChangeComboVendedores } " data-validation="required" data-validation-error-msg="No existe vendedor Asignado">
          </select>
        </div>
      </div>
    </div>

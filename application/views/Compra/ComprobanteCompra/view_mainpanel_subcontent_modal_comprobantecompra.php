<div class="modal fade" data-backdrop-limit="1" tabindex="-1" role="dialog"  id="modalComprobanteCompra"
        ...
        <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="col-md-8" style="float:right;">
                <?php echo $view_panel_header_comprobantecompra; ?>
              </div>
            </div>
            <div class="modal-body">
                <?php echo $view_form_comprobantecompra; ?>
            </div>
        </div>
    </div>
</div>

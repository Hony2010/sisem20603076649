                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <h3 class="panel-title"style="margin-top: 6px;">
                        REGISTRO DE NOTA DE DEBITO COMPRA
                      </h3>
                    </div>
                  </div>
                  <div class="col-md-8">
                    <?php echo $view_subcontent_form_header_notadebitocompra; ?>
                  </div>
                </div>
              </div>
              <div class="panel-body">
                <div class="datalist__result">
                  <?php echo $view_subcontent_form_notadebitocompra; ?>
                </div>
              </div>
            </div>
          </div>

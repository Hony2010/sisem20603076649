<!-- ko with : CompraGasto -->
<form id="formCompraGasto" name="formCompraGasto" role="form" autocomplete="off">
	<div class="datalist__result">
		...
		<input id="IdCompraGasto" class="form-control" type="hidden" placeholder="IdCompraGasto">
								...
								<div class="col-md-6">
									<div class="form-group">
										<div class="input-group">
											...
											<input id="Proveedor" name="Proveedor" class="form-control formulario" type="text"
											...
											<div class="input-group-btn">
												<button type="button" class="btn-buscar btn btn-default no-tab" id="BtnNuevoProveedor"
								...
								<div class="col-md-6">
									<div class="form-group">
										<div class="input-group">
											...
											<input readonly tabindex="-1" class="form-control formulario no-tab" id="Direccion"
												data-bind="value : Direccion" type="text">
										</div>
									</div>
								</div>
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<div class="form-group">
										<div class="input-group">
											...
											<input id="FechaVencimiento" name="FechaVencimiento" class="form-control formulario"
												data-inputmask-clearmaskonlostfocus="false"
								...
								<div class="col-md-3">
									<div class="form-group">
										<div class="input-group">
											...
											<input id="SerieDocumento" type="text" name="" class="form-control formulario" value=""
										...
										<div id="GrupoAlmacen" class="col-md-4">
											<div class="form-group">
												...
												<div class="radio radio-inline">
													<input disabled tabindex="-1" id="radioCliente" type="radio" name="radioD" class="no-tab"
														value="1"
												...
												<div class="radio radio-inline">
													<input disabled tabindex="-1" id="radioProveedor" type="radio" name="radioD" class="no-tab"
														value="2"
														data-bind="checked : PagadorDetraccion, event : {focus : OnFocus, keydown : OnKeyEnter}">
													<label for="radioProveedor" style="font-size : 13px">Proveedor</label>
												</div>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
												<div class="input-group">
													...
													<input id="DocumentoDetraccion" class="form-control formulario no-tab" type="text"
										...
										<div class="col-md-3">
											<div class="form-group">
												<div class="input-group">
													...
													<input disabled id="FechaDetraccion" name="Fecha" class="form-control formulario no-tab"
														type="text" data-inputmask-clearmaskonlostfocus="false"
										...
										<div class="col-md-2">
											<div class="form-group">
												<div class="input-group">
													...
													<input disabled id="Monto" class="form-control formulario numeric text-mumeric no-tab"
														type="text"
					...
					<div class="col-md-12">
						<div class="row detalle-comprobante">
							<div class="col-md-12">
									...
									<table class="datalist__table table display grid-detail-body table-border" width="100%"
										...
										<thead>
											<tr>
												...
												<th class="col-sm-2 products__title">Precio Unit.</th>
												<!-- /ko -->
												<!-- ko if: IndicadorTipoCalculoIGV() == 0 -->
												<th class="col-sm-2 products__title">Valor Unit.</th>
												<!-- /ko -->
										...
										<tbody>
											<!-- ko foreach : DetallesCompraGasto -->
                              ...
                              attr : { id : IdDetalleComprobanteCompra() + '_input_IdProducto'}," type="hidden"
                                ...
                                event: {focus : function(data,event) { return OnFocus(data,event,$parent.OnRefrescar); }  }" type="text"
															data-validation="autocompletado_producto" data-validation-value=""
                          ...
                          numberdecimal : PrecioUnitario" type="text" data-validation="number_calc"
												...
												<td class="col-sm-2">
													<input name="CostoUnitario" class="form-control  formulario numeric text-mumeric inputs"
                              ...
                              numberdecimal : CostoUnitario" type="text" data-validation="number_calc"
												...
												<td class="col-sm-1">
													<div class="form-group">
														<select name="AfectoIGV" id="AfectoIGV" class="form-control formulario" data-bind="
                                value : AfectoIGV ,
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<input id="IGV" readonly tabindex="-1"
								class="form-control formulario numeric text-mumeric input-totales no-tab" type="text" placeholder="IGV"
								data-bind="value: CalculoTotalIGV()">
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<input id="TasaPercepcionPorcentaje"
								class="form-control formulario numeric text-mumeric input-totales no-tab" type="text" data-bind="

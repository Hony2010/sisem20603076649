...
class sReporteDocumentosPorCobrar extends MY_Service {
  ...
  function ObtenerNombreArchivoReporte()
  {
    ...
    $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_DOCUMENTOS_POR_COBRAR;
  ...
  {
    $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_DOCUMENTOS_POR_COBRAR;
    $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
    if (is_string($resultado))
    {
      return $resultado;

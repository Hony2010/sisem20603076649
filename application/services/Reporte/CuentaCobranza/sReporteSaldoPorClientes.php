...
class sReporteSaldoPorClientes extends MY_Service {
  ...
  function ObtenerNombreArchivoReporte()
  {
    ...
    $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_SALDOS_POR_CLIENTES;
  ...
  {
    $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_SALDOS_POR_CLIENTES;
    $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
    if (is_string($resultado))
    {
      return $resultado;

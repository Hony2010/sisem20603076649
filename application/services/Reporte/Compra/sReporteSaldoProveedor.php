<?php
  ...
  class sReporteSaldoProveedor extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_SALDO_PROVEEDOR;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_SALDO_PROVEEDOR;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

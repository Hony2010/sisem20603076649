<?php
  ...
  class sReporteProductoProveedor extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_CODIGO_PRODUCTO_PROVEEDOR;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_CODIGO_PRODUCTO_PROVEEDOR;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

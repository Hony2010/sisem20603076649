<?php
  ...
  class sComprasMensuales extends MY_Service {

          public $ComprasMensuales = array();
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_COMPRAS_MENSUALES;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_COMPRAS_MENSUALES;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

<?php
  ...
  class sCompraDetallado extends MY_Service {

          public $CompraDetallado = array();
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_DETALLADO_COMPRA;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_DETALLADO_COMPRA;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

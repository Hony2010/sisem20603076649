<?php
  ...
  class sCompraGeneral extends MY_Service {

          public $CompraGeneral = array();
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_GENERAL_COMPRA;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_GENERAL_COMPRA;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

<?php
  ...
  class sProductosMasComprados extends MY_Service {

          public $ProductosMasComprados = array();
          ...
          public function __construct()
          {
                ...
                $this->load->model('Compra/mDetalleComprobanteCompra');//para contarcantidad de productos vendidos
          ...
          {
            $resultado = $this->mDetalleComprobanteCompra->TotalProductosComprados();
            return $resultado[0]['total'];
          }

          function CantidadFilas($data)
          {
            $totalproducto = $this->TotalProductosComprados();
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_PRODUCTO_MAS_COMPRADO;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_PRODUCTO_MAS_COMPRADO;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

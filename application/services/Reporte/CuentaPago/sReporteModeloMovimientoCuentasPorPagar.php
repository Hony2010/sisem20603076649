...
class sReporteModeloMovimientoCuentasPorPagar extends MY_Service {
  ...
  function ObtenerNombreArchivoReporte()
  {
    ...
    $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_MODELO_MOVIMIENTO_CUENTAS_POR_PAGAR;
  ...
  {
    $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_MODELO_MOVIMIENTO_CUENTAS_POR_PAGAR;
    $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
    if (is_string($resultado))
    {
      return $resultado;

<?php
  ...
  class sReporteDetalladoCuentasPorPagar extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_DETALLADO_CUENTAS_POR_PAGAR;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_DETALLADO_CUENTAS_POR_PAGAR;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

...
class sReporteDeudasProveedor extends MY_Service {
  ...
  function ObtenerNombreArchivoReporte()
  {
    ...
    $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_DEUDAS_PROVEEDOR;
  ...
  {
    $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_DEUDAS_PROVEEDOR;
    $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
    if (is_string($resultado))
    {
      return $resultado;

<?php
  ...
  class sProductosMasVendidos extends MY_Service {

          public $ProductosMasVendidos = array();
          ...
          function GenerarReportePDF($data)
          {
            ...
            $data['OrdenadoPor'] =(int)$data['OrdenadoPor'];
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_PRODUCTO_MAS_VENDIDO;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_PRODUCTO_MAS_VENDIDO;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

...
class sVentaDetallado extends MY_Service
{
  ...
  function ObtenerNombreArchivoReporte()
  {
    ...
    $data['IdParametroSistema'] = NOMBRE_ARCHIVO_REPORTE_DETALLADO;
  ...
  {
    $data['IdParametroSistema'] = NOMBRE_ARCHIVO_JASPER_DETALLADO;
    $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
    if (is_string($resultado)) {
      return $resultado;
    } else {

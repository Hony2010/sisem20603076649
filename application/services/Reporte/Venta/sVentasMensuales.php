<?php
  ...
  class sVentasMensuales extends MY_Service {

          public $VentasMensuales = array();
          ...
          {
            $data["AnioInicial"] = ($data["FechaInicio_Mensual"]);
            $data["AnioFinal"] = ($data["FechaFinal_Mensual"]);
            $data["NombreArchivoReporte"] = $data["NombreArchivoReporte_Mensual"];
            $data["NombreArchivoJasper"] = $data["NombreArchivoJasper_Mensual"];
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_VENTAS_MENSUALES;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_VENTAS_MENSUALES;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

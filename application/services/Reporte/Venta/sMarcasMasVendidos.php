<?php
  ...
  class sMarcasMasVendidos extends MY_Service {

          public $MarcasMasVendidos = array();
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_MARCA_MAS_VENDIDO;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_MARCA_MAS_VENDIDO;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

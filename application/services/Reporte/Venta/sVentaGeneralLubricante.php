...
class sVentaGeneralLubricante extends MY_Service {

  public $VentaGeneralLubricante = array();
  ...
  function ObtenerNombreArchivoReporte() {
    ...
    $data['IdParametroSistema'] = NOMBRE_ARCHIVO_REPORTE_VENTA_GENERAL_LUBRICANTE;
  ...
  function ObtenerNombreArchivoJasper() {
    $data['IdParametroSistema'] = NOMBRE_ARCHIVO_JASPER_VENTA_GENERAL_LUBRICANTE;
    $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
    if (is_string($resultado)) {
      return $resultado;
    } else {

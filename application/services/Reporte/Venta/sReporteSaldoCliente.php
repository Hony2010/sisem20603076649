<?php
  ...
  class sReporteSaldoCliente extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_SALDO_CLIENTE;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_SALDO_CLIENTE;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

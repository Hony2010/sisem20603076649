<?php
  ...
  class sVentasPorMercaderia extends MY_Service {

          public $VentasPorMercaderia = array();
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_VENTAS_POR_MERCADERIAS;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_VENTAS_POR_MERCADERIA;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

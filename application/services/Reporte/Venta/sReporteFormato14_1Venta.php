<?php
  ...
  class sReporteFormato14_1Venta extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_REGISTRO_VENTA;
          ...
          function ObtenerNombreArchivoJasper()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_REGISTRO_VENTA;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

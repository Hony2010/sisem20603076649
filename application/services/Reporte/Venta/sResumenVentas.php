<?php
  ...
  class sResumenVentas extends MY_Service {

    public $ResumenVentas = array();
    ...
    function ObtenerNombreArchivoReporte()
    {
      ...
      $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_RESUMEN_VENTAS;
    ...
    {
      $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_RESUMEN_VENTAS;
      $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
      if (is_string($resultado))
      {
        return $resultado;

<?php
  ...
  class sGananciaPorPrecioBaseProducto extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_GANANCIA_POR_PRECIO_BASE_PRODUCTO;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_GANANCIA_POR_PRECIO_BASE_PRODUCTO;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

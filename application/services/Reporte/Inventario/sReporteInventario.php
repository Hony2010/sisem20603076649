<?php
  ...
  class sReporteInventario extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_INVENTARIO;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_INVENTARIO;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

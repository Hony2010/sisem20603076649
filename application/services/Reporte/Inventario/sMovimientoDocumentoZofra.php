<?php
  ...
  class sMovimientoDocumentoZofra extends MY_Service {
          ...
          function GenerarReportePDF($data)
          {
            ...
            if ($data['Saldos'] == 1) {
              $resultadoalamcen= $this->sMovimientoDocumentoSalidaZofra->CalcularCantidadesProductoPorMovimientoDocumentoSalidaZofra($data);
            }
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_MOVIMIENTO_DOCUMENTO_ZOFRA;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_MOVIMIENTO_DOCUMENTO_ZOFRA;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

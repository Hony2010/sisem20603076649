<?php
  ...
  class sMovimientoAlmacenDocumentoIngreso extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_MOVIMIENTO_ALMACEN_DOCUMENTO_INGRESO;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_MOVIMIENTO_ALMACEN_DOCUMENTO_INGRESO;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

<?php
  ...
  class sStockProducto extends MY_Service {
          ...
          function GenerarReportePDF($input)
          {
            ...
            $data["FechaDeterminada"] = convertToDate($input['Fecha_StockProducto'] == 0 ? $input["FechaHoy_StockProducto"] : $input["FechaDeterminada_StockProducto"]);
            $data["Orden"] = $input["Orden"];
            $data["NombreArchivoReporte"] = $input["NombreArchivoReporte_StockProducto"];
            $data["NombreArchivoJasper"] = $input['Fecha_StockProducto'] == 0 ? $this->ObtenerNombreArchivoJasper() : $this->ObtenerSegundoNombreArchivoJasper();
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_STOCK_PRODUCTO;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_STOCK_PRODUCTO;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_STOCK_PRODUCTO_FECHA_DETERMINADA;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

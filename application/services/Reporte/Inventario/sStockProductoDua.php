<?php
  ...
  class sStockProductoDua extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_STOCK_PRODUCTO_DUA;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_STOCK_PRODUCTO_DUA;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_STOCK_PRODUCTO_DUA_FECHA_DETERMINADA;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

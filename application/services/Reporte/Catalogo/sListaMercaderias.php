<?php
  ...
  class sListaMercaderias extends MY_Service {

          public $ListaMercaderias = array();
          ...
          */
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_LISTA_MERCADERIAS;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_LISTA_MERCADERIAS;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

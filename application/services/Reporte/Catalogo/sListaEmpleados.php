<?php
  ...
  class sListaEmpleados extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_LISTA_EMPLEADOS;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_LISTA_EMPLEADOS;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

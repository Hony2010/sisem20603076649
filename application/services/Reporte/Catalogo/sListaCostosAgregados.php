<?php
  ...
  class sListaCostosAgregados extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_LISTA_COSTOS_AGREGADOS;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_LISTA_COSTOS_AGREGADOS;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

<?php
  ...
  class sListaOtrasVentas extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_LISTA_OTRAS_VENTAS;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_LISTA_OTRAS_VENTAS;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

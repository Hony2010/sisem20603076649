<?php
  ...
  class sListaMarcasModelos extends MY_Service {
          ...
          function ObtenerNombreArchivoReporte()
          {
            ...
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_LISTA_MARCAS_MODELOS;
          ...
          {
            $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_LISTA_MARCAS_MODELOS;
            $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
            if (is_string($resultado))
            {
              return $resultado;

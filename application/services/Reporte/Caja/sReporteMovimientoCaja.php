...
class sReporteMovimientoCaja extends MY_Service {
  ...
  function ObtenerNombreArchivoReporte()
  {
    ...
    $data['IdParametroSistema']= NOMBRE_ARCHIVO_REPORTE_MOVIMIENTO_CAJA;
  ...
  {
    $data['IdParametroSistema']= NOMBRE_ARCHIVO_JASPER_MOVIMIENTO_CAJA;
    $resultado = $this->sParametroSistema->ObtenerParametroSistemaPorId($data);
    if (is_string($resultado))
    {
      return $resultado;

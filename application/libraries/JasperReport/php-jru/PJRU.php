...
/*
  ...
  {
    $this->printerNameDefault=$printerName;
    return $printerName;
  }

  function printReport($inputFileName,$parameters,$conn) {
		try {
        //CREAMOS INSTANCIAS PARA LIBRERIAS Java
        ...
        $PrinterJob =  Java ('java.awt.print.PrinterJob');
        $PrinterJob = $PrinterJob->getPrinterJob();
        $PageFormat =  Java ('java.awt.print.PageFormat');
        $PageFormat = $PrinterJob->defaultPage();
        $PrinterJob->defaultPage($PageFormat);
        $selectedService = 0;
        $AttributeSet = new Java ('javax.print.attribute.AttributeSet');
        $PrinterName = new Java ('javax.print.attribute.standard.PrinterName',$this->printerNameDefault, null);
        $AttributeSet = new Java ('javax.print.attribute.HashPrintServiceAttributeSet', $PrinterName);
        $PrintService = new Java ('javax.print.PrintService');
        $PrintServiceLookup = Java ('javax.print.PrintServiceLookup');
        $PrintService = $PrintServiceLookup->lookupPrintServices(null, $AttributeSet);

        $PrinterJob->setPrintService($PrintService[$selectedService]);

        $exporter =  new Java ('net.sf.jasperreports.engine.export.JRPrintServiceExporter');
        $HashPrintRequestAttributeSet = new Java ('javax.print.attribute.HashPrintRequestAttributeSet');
        $PrintRequestAttributeSet =  new Java ('javax.print.attribute.PrintRequestAttributeSet');
        $PrintRequestAttributeSet = $HashPrintRequestAttributeSet;
        $MediaSizeName  =  new Java ('javax.print.attribute.standard.MediaSizeName');
        $Copies  =  new Java ('javax.print.attribute.standard.Copies', 1);
        //$PrintRequestAttributeSet->add($MediaSizeName->NA_LETTER);
        $PrintRequestAttributeSet->add($Copies);

        $JRExporterParameter  =  new Java ('net.sf.jasperreports.engine.JRExporterParameter');
        $JRPrintServiceExporterParameter  =  new Java ('net.sf.jasperreports.engine.export.JRPrintServiceExporterParameter');
  ...
  function getPrinterNameDefault() {
    try {
      $service = new Java('javax.print.PrintService');
      $PrintServiceLookup = Java('javax.print.PrintServiceLookup');

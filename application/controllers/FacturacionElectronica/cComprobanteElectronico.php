...
class cComprobanteElectronico extends CI_Controller  {
	...
	public function ValidarComprobobanteElectronico()
	{
		try {
			...
			// $data["FechaEmision"]="15/04/2019";
			// $data["Total"]="2619.60";
			$resultado = $this->sComprobanteElectronico->ConsultarEstadoComprobanteValido($data);
	...
	public function ValidarEstadoComprobobanteElectronico()
	{
		try {
			...
			// $data["SerieDocumento"]="F001";
			// $data["NumeroDocumento"]="00000032";
			$resultado = $this->sComprobanteElectronico->ConsultarEstadoComprobante($data);
			echo $this->json->json_response($resultado);
		} 
		catch (Exception $e) {
			echo $this->json->json_response_error($e);
	...
	{
		try {
			$resultado = $this->sComprobanteElectronico->ConsultarFacturasNoEnviadasSunat();
			echo $this->json->json_response($resultado);
		} 
		catch (Exception $e) {
			echo $this->json->json_response_error($e);
	...
	{
		try {
			$resultado = $this->sComprobanteElectronico->ValidarFechaVencimientoCertificadoDigital();
			echo $this->json->json_response($resultado);
		} 
		catch (Exception $e) {
			echo $this->json->json_response_error($e);

...
class cEmisionBoletaTipoTVenta extends CI_Controller  {
	...
	public function __construct()
	{
		...
		$this->load->service("Venta/sBoletaTipoTVenta");
	...
	public function Index()
	{
		...
		$BoletaVenta = $this->sBoletaTipoTVenta->CargarBoleta();
    ...
    $view_data['data'] = $data;
		...
		$views['view_tipoventa_boletaventa'] = $this->load->View('Venta/EmisionBoletaTipoTVenta/view_tipoventa_boletatipotventa','',true);
		$views['view_panel_boletaventa'] = $this->load->View('Venta/EmisionBoletaTipoTVenta/view_panel_boletatipotventa',$view_form,true);

		$view['view_footer_extension'] = $this->load->View('Venta/EmisionBoletaTipoTVenta/view_footer_boletatipotventa',$view_data,true);
		$view['view_content_min'] =  $this->load->View('Venta/EmisionBoletaTipoTVenta/view_content_boletatipotventa',$views,true);

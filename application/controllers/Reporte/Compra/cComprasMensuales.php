...
class cComprasMensuales extends CI_Controller  {
	...
	public function GenerarReporteEXCEL()
	{
		...
		$resultado = $this->sComprasMensuales->GenerarReporteEXCEL($data);
	...
	public function GenerarReportePDF()
	{
		...
		$resultado = $this->sComprasMensuales->GenerarReportePDF($data);
	...
	public function GenerarReportePANTALLA()
	{
		$data = $this->input->post("Data");
		$data["Año"] = $data["Ano"];
		$resultado = $this->sComprasMensuales->GenerarReportePANTALLA($data);
		echo $this->json->json_response($resultado);
	}
	...
	function DescargarArchivo()
	{
		...
		$resultado = $this->sComprasMensuales->DescargarArchivo($data);
		echo $this->json->json_response($resultado);
	}
